...
function MsiDatabaseOpenViewA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseOpenViewA';
function MsiDatabaseOpenViewW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseOpenViewW';
function MsiDatabaseOpenView; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseOpenView' + AWSuffix;
function MsiViewGetErrorA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewGetErrorA';
function MsiViewGetErrorW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewGetErrorW';
function MsiViewGetError; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewGetError' + AWSuffix;
function MsiViewExecute; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewExecute';
function MsiViewFetch; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewFetch';
function MsiViewModify; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewModify';
function MsiViewGetColumnInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewGetColumnInfo';
function MsiViewClose; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiViewClose';
function MsiDatabaseGetPrimaryKeysA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGetPrimaryKeysA';
function MsiDatabaseGetPrimaryKeysW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGetPrimaryKeysW';
function MsiDatabaseGetPrimaryKeys; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGetPrimaryKeys' + AWSuffix;
function MsiDatabaseIsTablePersistentA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseIsTablePersistentA';
function MsiDatabaseIsTablePersistentW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseIsTablePersistentW';
function MsiDatabaseIsTablePersistent; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseIsTablePersistent' + AWSuffix;
function MsiGetSummaryInformationA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSummaryInformationA';
function MsiGetSummaryInformationW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSummaryInformationW';
function MsiGetSummaryInformation; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSummaryInformation' + AWSuffix;
function MsiSummaryInfoGetPropertyCount; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoGetPropertyCount';
function MsiSummaryInfoSetPropertyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoSetPropertyA';
function MsiSummaryInfoSetPropertyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoSetPropertyW';
function MsiSummaryInfoSetProperty; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoSetProperty' + AWSuffix;
function MsiSummaryInfoGetPropertyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoGetPropertyA';
function MsiSummaryInfoGetPropertyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoGetPropertyW';
function MsiSummaryInfoGetProperty; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoGetProperty' + AWSuffix;
function MsiSummaryInfoPersist; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSummaryInfoPersist';
function MsiOpenDatabaseA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenDatabaseA';
function MsiOpenDatabaseW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenDatabaseW';
function MsiOpenDatabase; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenDatabase' + AWSuffix;
function MsiDatabaseImportA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseImportA';
function MsiDatabaseImportW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseImportW';
function MsiDatabaseImport; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseImport' + AWSuffix;
function MsiDatabaseExportA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseExportA';
function MsiDatabaseExportW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseExportW';
function MsiDatabaseExport; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseExport' + AWSuffix;
function MsiDatabaseMergeA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseMergeA';
function MsiDatabaseMergeW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseMergeW';
function MsiDatabaseMerge; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseMerge' + AWSuffix;
function MsiDatabaseGenerateTransformA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGenerateTransformA';
function MsiDatabaseGenerateTransformW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGenerateTransformW';
function MsiDatabaseGenerateTransform; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseGenerateTransform' + AWSuffix;
function MsiDatabaseApplyTransformA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseApplyTransformA';
function MsiDatabaseApplyTransformW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseApplyTransformW';
function MsiDatabaseApplyTransform; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseApplyTransform' + AWSuffix;
function MsiCreateTransformSummaryInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCreateTransformSummaryInfoA';
function MsiCreateTransformSummaryInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCreateTransformSummaryInfoW';
function MsiCreateTransformSummaryInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCreateTransformSummaryInfo' + AWSuffix;
function MsiDatabaseCommit; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDatabaseCommit';
function MsiGetDatabaseState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetDatabaseState';
function MsiCreateRecord; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCreateRecord';
function MsiRecordIsNull; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordIsNull';
function MsiRecordDataSize; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordDataSize';
function MsiRecordSetInteger; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetInteger';
function MsiRecordSetStringA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetStringA';
function MsiRecordSetStringW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetStringW';
function MsiRecordSetString; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetString' + AWSuffix;
function MsiRecordGetInteger; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordGetInteger';
function MsiRecordGetStringA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordGetStringA';
function MsiRecordGetStringW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordGetStringW';
function MsiRecordGetString; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordGetString' + AWSuffix;
function MsiRecordGetFieldCount; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordGetFieldCount';
function MsiRecordSetStreamA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetStreamA';
function MsiRecordSetStreamW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetStreamW';
function MsiRecordSetStream; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordSetStream' + AWSuffix;
function MsiRecordReadStream; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordReadStream';
function MsiRecordClearData; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiRecordClearData';
function MsiGetActiveDatabase; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetActiveDatabase';
function MsiSetPropertyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetPropertyA';
function MsiSetPropertyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetPropertyW';
function MsiSetProperty; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetProperty' + AWSuffix;
function MsiGetPropertyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetPropertyA';
function MsiGetPropertyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetPropertyW';
function MsiGetProperty; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProperty' + AWSuffix;
function MsiGetLanguage; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetLanguage';
function MsiGetMode; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetMode';
function MsiSetMode; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetMode';
function MsiFormatRecordA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiFormatRecordA';
function MsiFormatRecordW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiFormatRecordW';
function MsiFormatRecord; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiFormatRecord' + AWSuffix;
function MsiDoActionA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDoActionA';
function MsiDoActionW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDoActionW';
function MsiDoAction; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiDoAction' + AWSuffix;
function MsiSequenceA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSequenceA';
function MsiSequenceW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSequenceW';
function MsiSequence; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSequence' + AWSuffix;
function MsiProcessMessage; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProcessMessage';
function MsiEvaluateConditionA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEvaluateConditionA';
function MsiEvaluateConditionW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEvaluateConditionW';
function MsiEvaluateCondition; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEvaluateCondition' + AWSuffix;
function MsiGetFeatureStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureStateA';
function MsiGetFeatureStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureStateW';
function MsiGetFeatureState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureState' + AWSuffix;
function MsiSetFeatureStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureStateA';
function MsiSetFeatureStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureStateW';
function MsiSetFeatureState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureState' + AWSuffix;
function MsiSetFeatureAttributesA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureAttributesA';
function MsiSetFeatureAttributesW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureAttributesW';
function MsiSetFeatureAttributes; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetFeatureAttributes' + AWSuffix;
function MsiGetComponentStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentStateA';
function MsiGetComponentStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentStateW';
function MsiGetComponentState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentState' + AWSuffix;
function MsiSetComponentStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetComponentStateA';
function MsiSetComponentStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetComponentStateW';
function MsiSetComponentState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetComponentState' + AWSuffix;
function MsiGetFeatureCostA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureCostA';
function MsiGetFeatureCostW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureCostW';
function MsiGetFeatureCost; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureCost' + AWSuffix;
function MsiEnumComponentCostsA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentCostsA';
function MsiEnumComponentCostsW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentCostsW';
function MsiEnumComponentCosts; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentCosts' + AWSuffix;
function MsiSetInstallLevel; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetInstallLevel';
function MsiGetFeatureValidStatesA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureValidStatesA';
function MsiGetFeatureValidStatesW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureValidStatesW';
function MsiGetFeatureValidStates; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureValidStates' + AWSuffix;
function MsiGetSourcePathA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSourcePathA';
function MsiGetSourcePathW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSourcePathW';
function MsiGetSourcePath; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetSourcePath' + AWSuffix;
function MsiGetTargetPathA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetTargetPathA';
function MsiGetTargetPathW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetTargetPathW';
function MsiGetTargetPath; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetTargetPath' + AWSuffix;
function MsiSetTargetPathA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetTargetPathA';
function MsiSetTargetPathW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetTargetPathW';
function MsiSetTargetPath; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetTargetPath' + AWSuffix;
function MsiVerifyDiskSpace; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiVerifyDiskSpace';
function MsiEnableUIPreview; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnableUIPreview';
function MsiPreviewDialogA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewDialogA';
function MsiPreviewDialogW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewDialogW';
function MsiPreviewDialog; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewDialog' + AWSuffix;
function MsiPreviewBillboardA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewBillboardA';
function MsiPreviewBillboardW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewBillboardW';
function MsiPreviewBillboard; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiPreviewBillboard' + AWSuffix;
function MsiGetLastErrorRecord; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetLastErrorRecord';
