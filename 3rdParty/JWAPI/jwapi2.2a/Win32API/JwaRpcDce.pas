...
{$ELSE}
function I_RpcBindingIsClientLocal; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'I_RpcBindingIsClientLocal';
function RpcBindingCopy; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingCopy';
function RpcBindingFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingFree';
function RpcBindingSetOption; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetOption';
function RpcBindingInqOption; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqOption';
function RpcBindingFromStringBindingA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingFromStringBindingA';
function RpcBindingFromStringBindingW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingFromStringBindingW';
function RpcBindingFromStringBinding; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingFromStringBinding' + AWSuffix;
function RpcSsGetContextBinding; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcSsGetContextBinding';
function RpcBindingInqObject; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqObject';
function RpcBindingReset; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingReset';
function RpcBindingSetObject; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetObject';
function RpcMgmtInqDefaultProtectLevel; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqDefaultProtectLevel';
function RpcBindingToStringBindingA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingToStringBindingA';
function RpcBindingToStringBindingW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingToStringBindingW';
function RpcBindingToStringBinding; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingToStringBinding' + AWSuffix;
function RpcBindingVectorFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingVectorFree';
function RpcStringBindingComposeA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingComposeA';
function RpcStringBindingComposeW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingComposeW';
function RpcStringBindingCompose; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingCompose' + AWSuffix;
function RpcStringBindingParseA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingParseA';
function RpcStringBindingParseW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingParseW';
function RpcStringBindingParse; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringBindingParse' + AWSuffix;
function RpcStringFreeA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringFreeA';
function RpcStringFreeW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringFreeW';
function RpcStringFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcStringFree' + AWSuffix;
function RpcIfInqId; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcIfInqId';
function RpcNetworkIsProtseqValidA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNetworkIsProtseqValidA';
function RpcNetworkIsProtseqValidW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNetworkIsProtseqValidW';
function RpcMgmtInqComTimeout; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqComTimeout';
function RpcMgmtSetComTimeout; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtSetComTimeout';
function RpcMgmtSetCancelTimeout; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtSetCancelTimeout';
function RpcNetworkInqProtseqsA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNetworkInqProtseqsA';
function RpcNetworkInqProtseqsW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNetworkInqProtseqsW';
function RpcNetworkInqProtseqs; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNetworkInqProtseqs' + AWSuffix;
function RpcObjectInqType; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcObjectInqType';
function RpcObjectSetInqFn; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcObjectSetInqFn';
function RpcObjectSetType; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcObjectSetType';
function RpcProtseqVectorFreeA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcProtseqVectorFreeA';
function RpcProtseqVectorFreeW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcProtseqVectorFreeW';
function RpcProtseqVectorFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcProtseqVectorFree' + AWSuffix;
function RpcServerInqBindings; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerInqBindings';
function RpcServerInqIf; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerInqIf';
function RpcServerListen; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerListen';
function RpcServerRegisterIf; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterIf';
function RpcServerRegisterIfEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterIfEx';
function RpcServerRegisterIf2; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterIf2';
function RpcServerUnregisterIf; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUnregisterIf';
function RpcServerUnregisterIfEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUnregisterIfEx';
function RpcServerUseAllProtseqs; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseAllProtseqs';
function RpcServerUseAllProtseqsEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseAllProtseqsEx';
function RpcServerUseAllProtseqsIf; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseAllProtseqsIf';
function RpcServerUseAllProtseqsIfEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseAllProtseqsIfEx';
function RpcServerUseProtseqA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqA';
function RpcServerUseProtseqW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqW';
function RpcServerUseProtseq; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseq' + AWSuffix;
function RpcServerUseProtseqExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqExA';
function RpcServerUseProtseqExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqExW';
function RpcServerUseProtseqEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEx' + AWSuffix;
function RpcServerUseProtseqEpA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEpA';
function RpcServerUseProtseqEpW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEpW';
function RpcServerUseProtseqEp; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEp' + AWSuffix;
function RpcServerUseProtseqEpExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEpExA';
function RpcServerUseProtseqEpExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEpExW';
function RpcServerUseProtseqEpEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqEpEx' + AWSuffix;
function RpcServerUseProtseqIfA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqIfA';
function RpcServerUseProtseqIfW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqIfW';
function RpcServerUseProtseqIfExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqIfExA';
function RpcServerUseProtseqIfExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqIfExW';
function RpcServerUseProtseqIfEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerUseProtseqIfEx' + AWSuffix;
procedure RpcServerYield; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerYield';
function RpcMgmtStatsVectorFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtStatsVectorFree';
function RpcMgmtInqStats; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqStats';
function RpcMgmtIsServerListening; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtIsServerListening';
function RpcMgmtStopServerListening; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtStopServerListening';
function RpcMgmtWaitServerListen; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtWaitServerListen';
function RpcMgmtSetServerStackSize; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtSetServerStackSize';
procedure RpcSsDontSerializeContext; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcSsDontSerializeContext';
function RpcMgmtEnableIdleCleanup; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEnableIdleCleanup';
function RpcMgmtInqIfIds; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqIfIds';
function RpcIfIdVectorFree; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcIfIdVectorFree';
function RpcMgmtInqServerPrincNameA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqServerPrincNameA';
function RpcMgmtInqServerPrincNameW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqServerPrincNameW';
function RpcMgmtInqServerPrincName; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtInqServerPrincName' + AWSuffix;
function RpcServerInqDefaultPrincNameA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerInqDefaultPrincNameA';
function RpcServerInqDefaultPrincNameW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerInqDefaultPrincNameW';
function RpcServerInqDefaultPrincName; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerInqDefaultPrincName' + AWSuffix;
function RpcEpResolveBinding; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpResolveBinding';
function RpcNsBindingInqEntryNameA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingInqEntryNameA';
function RpcNsBindingInqEntryNameW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingInqEntryNameW';
function RpcNsBindingInqEntryName; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingInqEntryName' + AWSuffix;
function RpcImpersonateClient; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcImpersonateClient';
function RpcRevertToSelfEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcRevertToSelfEx';
function RpcRevertToSelf; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcRevertToSelf';
function RpcBindingInqAuthClientA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClientA';
function RpcBindingInqAuthClientW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClientW';
function RpcBindingInqAuthClientExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClientExA';
function RpcBindingInqAuthClientExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClientExW';
function RpcBindingInqAuthInfoA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfoA';
function RpcBindingInqAuthInfoW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfoW';
function RpcBindingSetAuthInfoA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfoA';
function RpcBindingSetAuthInfoW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfoW';
function RpcBindingSetAuthInfoExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfoExA';
function RpcBindingSetAuthInfoExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfoExW';
function RpcBindingInqAuthInfoExA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfoExA';
function RpcBindingInqAuthInfoExW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfoExW';
function RpcServerRegisterAuthInfoA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterAuthInfoA';
function RpcServerRegisterAuthInfoW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterAuthInfoW';
function RpcBindingInqAuthClient; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClient' + AWSuffix;
function RpcBindingInqAuthClientEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthClientEx' + AWSuffix;
function RpcBindingInqAuthInfo; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfo' + AWSuffix;
function RpcBindingSetAuthInfo; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfo' + AWSuffix;
function RpcBindingSetAuthInfoEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingSetAuthInfoEx' + AWSuffix;
function RpcBindingInqAuthInfoEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingInqAuthInfoEx' + AWSuffix;
function RpcServerRegisterAuthInfo; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerRegisterAuthInfo' + AWSuffix;
function RpcBindingServerFromClient; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcBindingServerFromClient';
procedure RpcRaiseException; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcRaiseException';
function RpcTestCancel; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcTestCancel';
function RpcServerTestCancel; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcServerTestCancel';
function RpcCancelThread; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcCancelThread';
function RpcCancelThreadEx; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcCancelThreadEx';
function UuidCreate; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidCreate';
function UuidCreateSequential; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidCreateSequential';
function UuidFromStringA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidFromStringA';
function UuidFromStringW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidFromStringW';
function UuidFromString; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidFromString' + AWSuffix;
function UuidToStringA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidToStringA';
function UuidToStringW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidToStringW';
function UuidToString; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidToString' + AWSuffix;
function UuidCompare; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidCompare';
function UuidCreateNil; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidCreateNil';
function UuidEqual; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidEqual';
function UuidHash; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidHash';
function UuidIsNil; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UuidIsNil';
function RpcEpRegisterNoReplaceA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegisterNoReplaceA';
function RpcEpRegisterNoReplaceW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegisterNoReplaceW';
function RpcEpRegisterNoReplace; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegisterNoReplace' + AWSuffix;
function RpcEpRegisterA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegisterA';
function RpcEpRegisterW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegisterW';
function RpcEpRegister; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpRegister' + AWSuffix;
function RpcEpUnregister; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcEpUnregister';
function DceErrorInqTextA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DceErrorInqTextA';
function DceErrorInqTextW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DceErrorInqTextW';
function DceErrorInqText; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DceErrorInqText' + AWSuffix;
function RpcMgmtEpEltInqBegin; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpEltInqBegin';
function RpcMgmtEpEltInqDone; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpEltInqDone';
function RpcMgmtEpEltInqNextA; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpEltInqNextA';
function RpcMgmtEpEltInqNextW; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpEltInqNextW';
function RpcMgmtEpEltInqNext; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpEltInqNext' + AWSuffix;
function RpcMgmtEpUnregister; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtEpUnregister';
function RpcMgmtSetAuthorizationFn; external rpclib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcMgmtSetAuthorizationFn';
