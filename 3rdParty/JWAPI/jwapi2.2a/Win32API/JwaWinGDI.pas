...
function AddFontResourceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResourceA';
function AddFontResourceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResourceW';
function AddFontResource; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResource' + AWSuffix;
function AnimatePalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AnimatePalette';
function Arc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Arc';
function BitBlt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BitBlt';
function CancelDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CancelDC';
function Chord; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Chord';
function ChoosePixelFormat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChoosePixelFormat';
function CloseMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseMetaFile';
function CombineRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CombineRgn';
function CopyMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyMetaFileA';
function CopyMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyMetaFileW';
function CopyMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyMetaFile' + AWSuffix;
function CreateBitmap; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateBitmap';
function CreateBitmapIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateBitmapIndirect';
function CreateBrushIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateBrushIndirect';
function CreateCompatibleBitmap; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateCompatibleBitmap';
function CreateDiscardableBitmap; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDiscardableBitmap';
function CreateCompatibleDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateCompatibleDC';
function CreateDCA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDCA';
function CreateDCW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDCW';
function CreateDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDC' + AWSuffix;
function CreateDIBitmap; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDIBitmap';
function CreateDIBPatternBrush; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDIBPatternBrush';
function CreateDIBPatternBrushPt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDIBPatternBrushPt';
function CreateEllipticRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateEllipticRgn';
function CreateEllipticRgnIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateEllipticRgnIndirect';
function CreateFontIndirectA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirectA';
function CreateFontIndirectW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirectW';
function CreateFontIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirect' + AWSuffix;
function CreateFontA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontA';
function CreateFontW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontW';
function CreateFont; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFont' + AWSuffix;
function CreateHatchBrush; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateHatchBrush';
function CreateICA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateICA';
function CreateICW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateICW';
function CreateIC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateIC' + AWSuffix;
function CreateMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMetaFileA';
function CreateMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMetaFileW';
function CreateMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMetaFile' + AWSuffix;
function CreatePalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePalette';
function CreatePen; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePen';
function CreatePenIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePenIndirect';
function CreatePolyPolygonRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePolyPolygonRgn';
function CreatePatternBrush; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePatternBrush';
function CreateRectRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateRectRgn';
function CreateRectRgnIndirect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateRectRgnIndirect';
function CreateRoundRectRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateRoundRectRgn';
function CreateScalableFontResourceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateScalableFontResourceA';
function CreateScalableFontResourceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateScalableFontResourceW';
function CreateScalableFontResource; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateScalableFontResource' + AWSuffix;
function CreateSolidBrush; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateSolidBrush';
function DeleteDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteDC';
function DeleteMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteMetaFile';
function DeleteObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteObject';
function DescribePixelFormat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DescribePixelFormat';
function DeviceCapabilitiesA; external winspool32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeviceCapabilitiesA';
function DeviceCapabilitiesW; external winspool32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeviceCapabilitiesW';
function DeviceCapabilities; external winspool32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeviceCapabilities' + AWSuffix;
function DrawEscape; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawEscape';
function Ellipse; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Ellipse';
function EnumFontFamiliesExA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamiliesExA';
function EnumFontFamiliesExW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamiliesExW';
function EnumFontFamiliesEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamiliesEx' + AWSuffix;
function EnumFontFamiliesA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamiliesA';
function EnumFontFamiliesW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamiliesW';
function EnumFontFamilies; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontFamilies' + AWSuffix;
function EnumFontsA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontsA';
function EnumFontsW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFontsW';
function EnumFonts; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumFonts' + AWSuffix;
function EnumObjects; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumObjects';
function EqualRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EqualRgn';
function Escape; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Escape';
function ExtEscape; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtEscape';
function ExcludeClipRect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExcludeClipRect';
function ExtCreateRegion; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtCreateRegion';
function ExtFloodFill; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtFloodFill';
function FillRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FillRgn';
function FloodFill; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FloodFill';
function FrameRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FrameRgn';
function GetROP2; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetROP2';
function GetAspectRatioFilterEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAspectRatioFilterEx';
function GetBkColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBkColor';
function GetDCBrushColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDCBrushColor';
function GetDCPenColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDCPenColor';
function GetBkMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBkMode';
function GetBitmapBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBitmapBits';
function GetBitmapDimensionEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBitmapDimensionEx';
function GetBoundsRect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBoundsRect';
function GetBrushOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetBrushOrgEx';
function GetCharWidthA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthA';
function GetCharWidthW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthW';
function GetCharWidth; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidth' + AWSuffix;
function GetCharWidth32A; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidth32A';
function GetCharWidth32W; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidth32W';
function GetCharWidth32; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidth32' + AWSuffix;
function GetCharWidthFloatA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthFloatA';
function GetCharWidthFloatW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthFloatW';
function GetCharWidthFloat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthFloat' + AWSuffix;
function GetCharABCWidthsA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsA';
function GetCharABCWidthsW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsW';
function GetCharABCWidths; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidths' + AWSuffix;
function GetCharABCWidthsFloatA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsFloatA';
function GetCharABCWidthsFloatW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsFloatW';
function GetCharABCWidthsFloat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsFloat' + AWSuffix;
function GetClipBox; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipBox';
function GetClipRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipRgn';
function GetMetaRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMetaRgn';
function GetCurrentObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCurrentObject';
function GetCurrentPositionEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCurrentPositionEx';
function GetDeviceCaps; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDeviceCaps';
function GetDIBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDIBits';
function GetFontData; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetFontData';
function GetGlyphOutlineA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphOutlineA';
function GetGlyphOutlineW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphOutlineW';
function GetGlyphOutline; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphOutline' + AWSuffix;
function GetGraphicsMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGraphicsMode';
function GetMapMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMapMode';
function GetMetaFileBitsEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMetaFileBitsEx';
function GetMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMetaFileA';
function GetMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMetaFileW';
function GetMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMetaFile' + AWSuffix;
function GetNearestColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetNearestColor';
function GetNearestPaletteIndex; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetNearestPaletteIndex';
function GetObjectType; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetObjectType';
function GetOutlineTextMetricsA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetOutlineTextMetricsA';
function GetOutlineTextMetricsW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetOutlineTextMetricsW';
function GetOutlineTextMetrics; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetOutlineTextMetrics' + AWSuffix;
function GetPaletteEntries; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPaletteEntries';
function GetPixel; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPixel';
function GetPixelFormat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPixelFormat';
function GetPolyFillMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPolyFillMode';
function GetRasterizerCaps; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRasterizerCaps';
function GetRandomRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRandomRgn';
function GetRegionData; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRegionData';
function GetRgnBox; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRgnBox';
function GetStockObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetStockObject';
function GetStretchBltMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetStretchBltMode';
function GetSystemPaletteEntries; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSystemPaletteEntries';
function GetSystemPaletteUse; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSystemPaletteUse';
function GetTextCharacterExtra; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextCharacterExtra';
function GetTextAlign; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextAlign';
function GetTextColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextColor';
function GetTextExtentPointA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPointA';
function GetTextExtentPointW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPointW';
function GetTextExtentPoint; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPoint' + AWSuffix;
function GetTextExtentPoint32A; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPoint32A';
function GetTextExtentPoint32W; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPoint32W';
function GetTextExtentPoint32; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPoint32' + AWSuffix;
function GetTextExtentExPointA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentExPointA';
function GetTextExtentExPointW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentExPointW';
function GetTextExtentExPoint; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentExPoint' + AWSuffix;
function GetTextCharset; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextCharset';
function GetTextCharsetInfo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextCharsetInfo';
function TranslateCharsetInfo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateCharsetInfo';
function GetFontLanguageInfo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetFontLanguageInfo';
function GetCharacterPlacementA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharacterPlacementA';
function GetCharacterPlacementW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharacterPlacementW';
function GetCharacterPlacement; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharacterPlacement' + AWSuffix;
function GetFontUnicodeRanges; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetFontUnicodeRanges';
function GetGlyphIndicesA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphIndicesA';
function GetGlyphIndicesW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphIndicesW';
function GetGlyphIndices; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGlyphIndices' + AWSuffix;
function GetTextExtentPointI; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentPointI';
function GetTextExtentExPointI; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextExtentExPointI';
function GetCharWidthI; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharWidthI';
function GetCharABCWidthsI; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCharABCWidthsI';
function AddFontResourceExA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResourceExA';
function AddFontResourceExW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResourceExW';
function AddFontResourceEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontResourceEx' + AWSuffix;
function RemoveFontResourceExA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResourceExA';
function RemoveFontResourceExW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResourceExW';
function RemoveFontResourceEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResourceEx' + AWSuffix;
function AddFontMemResourceEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AddFontMemResourceEx';
function RemoveFontMemResourceEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontMemResourceEx';
function CreateFontIndirectExA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirectExA';
function CreateFontIndirectExW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirectExW';
function CreateFontIndirectEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateFontIndirectEx' + AWSuffix;
function GetViewportExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetViewportExtEx';
function GetViewportOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetViewportOrgEx';
function GetWindowExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowExtEx';
function GetWindowOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowOrgEx';
function IntersectClipRect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IntersectClipRect';
function InvertRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InvertRgn';
function LineDDA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LineDDA';
function LineTo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LineTo';
function MaskBlt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MaskBlt';
function PlgBlt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PlgBlt';
function OffsetClipRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OffsetClipRgn';
function OffsetRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OffsetRgn';
function PatBlt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PatBlt';
function Pie; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Pie';
function PlayMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PlayMetaFile';
function PaintRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PaintRgn';
function PolyPolygon; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyPolygon';
function PtInRegion; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PtInRegion';
function PtVisible; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PtVisible';
function RectInRegion; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RectInRegion';
function RectVisible; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RectVisible';
function Rectangle; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Rectangle';
function RestoreDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RestoreDC';
function ResetDCA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ResetDCA';
function ResetDCW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ResetDCW';
function ResetDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ResetDC' + AWSuffix;
function RealizePalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RealizePalette';
function RemoveFontResourceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResourceA';
function RemoveFontResourceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResourceW';
function RemoveFontResource; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveFontResource' + AWSuffix;
function RoundRect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RoundRect';
function ResizePalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ResizePalette';
function SaveDC; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SaveDC';
function SelectClipRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SelectClipRgn';
function ExtSelectClipRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtSelectClipRgn';
function SetMetaRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMetaRgn';
function SelectObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SelectObject';
function SelectPalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SelectPalette';
function SetBkColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBkColor';
function SetDCBrushColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDCBrushColor';
function SetDCPenColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDCPenColor';
function SetBkMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBkMode';
function SetBitmapBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBitmapBits';
function SetBoundsRect; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBoundsRect';
function SetDIBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDIBits';
function SetDIBitsToDevice; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDIBitsToDevice';
function SetMapperFlags; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMapperFlags';
function SetGraphicsMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetGraphicsMode';
function SetMapMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMapMode';
function SetLayout; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetLayout';
function GetLayout; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLayout';
function SetMetaFileBitsEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMetaFileBitsEx';
function SetPaletteEntries; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPaletteEntries';
function SetPixel; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPixel';
function SetPixelV; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPixelV';
function SetPixelFormat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPixelFormat';
function SetPolyFillMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPolyFillMode';
function StretchBlt; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StretchBlt';
function SetRectRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetRectRgn';
function StretchDIBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StretchDIBits';
function SetROP2; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetROP2';
function SetStretchBltMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetStretchBltMode';
function SetSystemPaletteUse; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetSystemPaletteUse';
function SetTextCharacterExtra; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetTextCharacterExtra';
function SetTextColor; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetTextColor';
function SetTextAlign; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetTextAlign';
function SetTextJustification; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetTextJustification';
function UpdateColors; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateColors';
function AlphaBlend; external msimg32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AlphaBlend';
function TransparentBlt; external msimg32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TransparentBlt';
function GradientFill; external msimg32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GradientFill';
function PlayMetaFileRecord; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PlayMetaFileRecord';
function EnumMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumMetaFile';
function CloseEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseEnhMetaFile';
function CopyEnhMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyEnhMetaFileA';
function CopyEnhMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyEnhMetaFileW';
function CopyEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyEnhMetaFile' + AWSuffix;
function CreateEnhMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateEnhMetaFileA';
function CreateEnhMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateEnhMetaFileW';
function CreateEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateEnhMetaFile' + AWSuffix;
function DeleteEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteEnhMetaFile';
function EnumEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumEnhMetaFile';
function GetEnhMetaFileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileA';
function GetEnhMetaFileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileW';
function GetEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFile' + AWSuffix;
function GetEnhMetaFileBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileBits';
function GetEnhMetaFileDescriptionA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileDescriptionA';
function GetEnhMetaFileDescriptionW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileDescriptionW';
function GetEnhMetaFileDescription; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileDescription' + AWSuffix;
function GetEnhMetaFileHeader; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFileHeader';
function GetEnhMetaFilePaletteEntries; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFilePaletteEntries';
function GetEnhMetaFilePixelFormat; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetEnhMetaFilePixelFormat';
function GetWinMetaFileBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWinMetaFileBits';
function PlayEnhMetaFile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PlayEnhMetaFile';
function PlayEnhMetaFileRecord; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PlayEnhMetaFileRecord';
function SetEnhMetaFileBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetEnhMetaFileBits';
function SetWinMetaFileBits; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWinMetaFileBits';
function GdiComment; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GdiComment';
function GetTextMetricsA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextMetricsA';
function GetTextMetricsW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextMetricsW';
function GetTextMetrics; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextMetrics' + AWSuffix;
function AngleArc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AngleArc';
function PolyPolyline; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyPolyline';
function GetWorldTransform; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWorldTransform';
function SetWorldTransform; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWorldTransform';
function ModifyWorldTransform; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ModifyWorldTransform';
function CombineTransform; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CombineTransform';
function CreateDIBSection; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDIBSection';
function GetDIBColorTable; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDIBColorTable';
function SetDIBColorTable; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDIBColorTable';
function SetColorAdjustment; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetColorAdjustment';
function GetColorAdjustment; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetColorAdjustment';
function CreateHalftonePalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateHalftonePalette';
function StartDocA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StartDocA';
function StartDocW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StartDocW';
function StartDoc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StartDoc' + AWSuffix;
function EndDoc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndDoc';
function StartPage; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StartPage';
function EndPage; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndPage';
function AbortDoc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AbortDoc';
function SetAbortProc; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetAbortProc';
function AbortPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AbortPath';
function ArcTo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ArcTo';
function BeginPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BeginPath';
function CloseFigure; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseFigure';
function EndPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndPath';
function FillPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FillPath';
function FlattenPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FlattenPath';
function GetPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPath';
function PathToRegion; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PathToRegion';
function PolyDraw; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyDraw';
function SelectClipPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SelectClipPath';
function SetArcDirection; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetArcDirection';
function SetMiterLimit; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMiterLimit';
function StrokeAndFillPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StrokeAndFillPath';
function StrokePath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'StrokePath';
function WidenPath; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WidenPath';
function ExtCreatePen; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtCreatePen';
function GetMiterLimit; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMiterLimit';
function GetArcDirection; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetArcDirection';
function GetObjectA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetObjectA';
function GetObjectW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetObjectW';
function GetObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetObject' + AWSuffix;
function MoveToEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MoveToEx';
function TextOutA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TextOutA';
function TextOutW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TextOutW';
function TextOut; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TextOut' + AWSuffix;
function ExtTextOutA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtTextOutA';
function ExtTextOutW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtTextOutW';
function ExtTextOut; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExtTextOut' + AWSuffix;
function PolyTextOutA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyTextOutA';
function PolyTextOutW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyTextOutW';
function PolyTextOut; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyTextOut' + AWSuffix;
function CreatePolygonRgn; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePolygonRgn';
function DPtoLP; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DPtoLP';
function LPtoDP; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LPtoDP';
function Polygon; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Polygon';
function Polyline; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'Polyline';
function PolyBezier; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyBezier';
function PolyBezierTo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolyBezierTo';
function PolylineTo; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PolylineTo';
function SetViewportExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetViewportExtEx';
function SetViewportOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetViewportOrgEx';
function SetWindowExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowExtEx';
function SetWindowOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowOrgEx';
function OffsetViewportOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OffsetViewportOrgEx';
function OffsetWindowOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OffsetWindowOrgEx';
function ScaleViewportExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScaleViewportExtEx';
function ScaleWindowExtEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScaleWindowExtEx';
function SetBitmapDimensionEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBitmapDimensionEx';
function SetBrushOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetBrushOrgEx';
function GetTextFaceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextFaceA';
function GetTextFaceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextFaceW';
function GetTextFace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTextFace' + AWSuffix;
function GetKerningPairsA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKerningPairsA';
function GetKerningPairsW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKerningPairsW';
function GetKerningPairs; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKerningPairs' + AWSuffix;
function GetDCOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDCOrgEx';
function FixBrushOrgEx; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FixBrushOrgEx';
function UnrealizeObject; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnrealizeObject';
function GdiFlush; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GdiFlush';
function GdiSetBatchLimit; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GdiSetBatchLimit';
function GdiGetBatchLimit; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GdiGetBatchLimit';
function SetICMMode; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetICMMode';
function CheckColorsInGamut; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CheckColorsInGamut';
function GetColorSpace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetColorSpace';
function GetLogColorSpaceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLogColorSpaceA';
function GetLogColorSpaceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLogColorSpaceW';
function GetLogColorSpace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLogColorSpace' + AWSuffix;
function CreateColorSpaceA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateColorSpaceA';
function CreateColorSpaceW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateColorSpaceW';
function CreateColorSpace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateColorSpace' + AWSuffix;
function SetColorSpace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetColorSpace';
function DeleteColorSpace; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteColorSpace';
function GetICMProfileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetICMProfileA';
function GetICMProfileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetICMProfileW';
function GetICMProfile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetICMProfile' + AWSuffix;
function SetICMProfileA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetICMProfileA';
function SetICMProfileW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetICMProfileW';
function SetICMProfile; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetICMProfile' + AWSuffix;
function GetDeviceGammaRamp; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDeviceGammaRamp';
function SetDeviceGammaRamp; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDeviceGammaRamp';
function ColorMatchToTarget; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ColorMatchToTarget';
function EnumICMProfilesA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumICMProfilesA';
function EnumICMProfilesW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumICMProfilesW';
function EnumICMProfiles; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumICMProfiles' + AWSuffix;
function UpdateICMRegKeyA; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateICMRegKeyA';
function UpdateICMRegKeyW; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateICMRegKeyW';
function UpdateICMRegKey; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateICMRegKey' + AWSuffix;
function ColorCorrectPalette; external gdi32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ColorCorrectPalette';
function wglCopyContext; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglCopyContext';
function wglCreateContext; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglCreateContext';
function wglCreateLayerContext; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglCreateLayerContext';
function wglDeleteContext; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglDeleteContext';
function wglGetCurrentContext; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglGetCurrentContext';
function wglGetCurrentDC; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglGetCurrentDC';
function wglGetProcAddress; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglGetProcAddress';
function wglMakeCurrent; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglMakeCurrent';
function wglShareLists; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglShareLists';
function wglUseFontBitmapsA; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontBitmapsA';
function wglUseFontBitmapsW; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontBitmapsW';
function wglUseFontBitmaps; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontBitmaps' + AWSuffix;
function SwapBuffers; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SwapBuffers';
function wglUseFontOutlinesA; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontOutlinesA';
function wglUseFontOutlinesW; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontOutlinesW';
function wglUseFontOutlines; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglUseFontOutlines' + AWSuffix;
function wglDescribeLayerPlane; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglDescribeLayerPlane';
function wglSetLayerPaletteEntries; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglSetLayerPaletteEntries';
function wglGetLayerPaletteEntries; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglGetLayerPaletteEntries';
function wglRealizeLayerPalette; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglRealizeLayerPalette';
function wglSwapLayerBuffers; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglSwapLayerBuffers';
function wglSwapMultipleBuffers; external opengl32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wglSwapMultipleBuffers';
