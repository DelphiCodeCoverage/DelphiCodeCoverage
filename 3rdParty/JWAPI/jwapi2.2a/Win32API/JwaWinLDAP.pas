...
function ldap_openA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_openA';
function ldap_openW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_openW';
function ldap_open; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_openA';
function ldap_initA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_initA';
function ldap_initW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_initW';
function ldap_init; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_initA';
function ldap_sslinitA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sslinitA';
function ldap_sslinitW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sslinitW';
function ldap_sslinit; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sslinitA';
function cldap_openA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'cldap_openA';
function cldap_openW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'cldap_openW';
function cldap_open; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'cldap_openA';
function ldap_simple_bindA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bindA';
function ldap_simple_bindW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bindW';
function ldap_simple_bind; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bindA';
function ldap_simple_bind_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bind_sA';
function ldap_simple_bind_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bind_sW';
function ldap_simple_bind_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_simple_bind_sA';
function ldap_bindA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bindA';
function ldap_bindW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bindW';
function ldap_bind; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bindA';
function ldap_bind_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bind_sA';
function ldap_bind_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bind_sW';
function ldap_bind_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_bind_sA';
function ldap_sasl_bindA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bindA';
function ldap_sasl_bindW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bindW';
function ldap_sasl_bind; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bindA';
function ldap_sasl_bind_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bind_sA';
function ldap_sasl_bind_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bind_sW';
function ldap_sasl_bind_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_sasl_bind_sA';
function ldap_searchA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_searchA';
function ldap_searchW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_searchW';
function ldap_search; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_searchA';
function ldap_search_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_sA';
function ldap_search_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_sW';
function ldap_search_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_sA';
function ldap_search_stA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_stA';
function ldap_search_stW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_stW';
function ldap_search_st; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_stA';
function ldap_modifyA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modifyA';
function ldap_modifyW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modifyW';
function ldap_modify; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modifyA';
function ldap_modify_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_sA';
function ldap_modify_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_sW';
function ldap_modify_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_sA';
function ldap_modrdn2A; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2A';
function ldap_modrdn2W; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2W';
function ldap_modrdn2; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2A';
function ldap_modrdnA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdnA';
function ldap_modrdnW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdnW';
function ldap_modrdn; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdnA';
function ldap_modrdn2_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2_sA';
function ldap_modrdn2_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2_sW';
function ldap_modrdn2_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn2_sA';
function ldap_modrdn_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn_sA';
function ldap_modrdn_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn_sW';
function ldap_modrdn_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modrdn_sA';
function ldap_addA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_addA';
function ldap_addW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_addW';
function ldap_add; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_addA';
function ldap_add_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_sA';
function ldap_add_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_sW';
function ldap_add_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_sA';
function ldap_compareA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compareA';
function ldap_compareW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compareW';
function ldap_compare; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compareA';
function ldap_compare_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_sA';
function ldap_compare_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_sW';
function ldap_compare_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_sA';
function ldap_deleteA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_deleteA';
function ldap_deleteW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_deleteW';
function ldap_delete; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_deleteA';
function ldap_delete_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_sA';
function ldap_delete_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_sW';
function ldap_delete_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_sA';
function ldap_err2stringA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_err2stringA';
function ldap_err2stringW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_err2stringW';
function ldap_err2string; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_err2stringA';
function ldap_first_attributeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_first_attributeA';
function ldap_first_attributeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_first_attributeW';
function ldap_first_attribute; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_first_attributeA';
function ldap_next_attributeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_next_attributeA';
function ldap_next_attributeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_next_attributeW';
function ldap_next_attribute; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_next_attributeA';
function ldap_get_valuesA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_valuesA';
function ldap_get_valuesW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_valuesW';
function ldap_get_values; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_valuesA';
function ldap_get_values_lenA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_values_lenA';
function ldap_get_values_lenW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_values_lenW';
function ldap_get_values_len; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_values_lenA';
function ldap_count_valuesA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_valuesA';
function ldap_count_valuesW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_valuesW';
function ldap_count_values; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_valuesA';
function ldap_value_freeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_value_freeA';
function ldap_value_freeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_value_freeW';
function ldap_value_free; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_value_freeA';
function ldap_get_dnA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_dnA';
function ldap_get_dnW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_dnW';
function ldap_get_dn; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_dnA';
function ldap_explode_dnA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_explode_dnA';
function ldap_explode_dnW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_explode_dnW';
function ldap_explode_dn; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_explode_dnA';
function ldap_dn2ufnA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_dn2ufnA';
function ldap_dn2ufnW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_dn2ufnW';
function ldap_dn2ufn; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_dn2ufnA';
procedure ldap_memfreeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_memfreeA';
procedure ldap_memfreeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_memfreeW';
procedure ldap_memfree; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_memfreeA';
function ldap_ufn2dnA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_ufn2dnA';
function ldap_ufn2dnW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_ufn2dnW';
function ldap_ufn2dn; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_ufn2dnA';
function ldap_escape_filter_elementA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_escape_filter_elementA';
function ldap_escape_filter_elementW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_escape_filter_elementW';
function ldap_escape_filter_element; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_escape_filter_elementA';
function ldap_search_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_extA';
function ldap_search_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_extW';
function ldap_search_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_extA';
function ldap_search_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_ext_sA';
function ldap_search_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_ext_sW';
function ldap_search_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_ext_sA';
function ldap_check_filterA; EXTERNAL LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_check_filterA';
function ldap_check_filterW; EXTERNAL LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_check_filterW';
function ldap_check_filter; EXTERNAL LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_check_filterA';
function ldap_modify_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_extA';
function ldap_modify_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_extW';
function ldap_modify_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_extA';
function ldap_modify_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_ext_sA';
function ldap_modify_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_ext_sW';
function ldap_modify_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_modify_ext_sA';
function ldap_rename_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_extA';
function ldap_rename_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_extW';
function ldap_rename_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_extA';
function ldap_rename_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_ext_sA';
function ldap_rename_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_ext_sW';
function ldap_rename_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_rename_ext_sA';
function ldap_add_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_extA';
function ldap_add_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_extW';
function ldap_add_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_extA';
function ldap_add_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_ext_sA';
function ldap_add_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_ext_sW';
function ldap_add_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_add_ext_sA';
function ldap_compare_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_extA';
function ldap_compare_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_extW';
function ldap_compare_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_extA';
function ldap_compare_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_ext_sA';
function ldap_compare_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_ext_sW';
function ldap_compare_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_compare_ext_sA';
function ldap_delete_extA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_extA';
function ldap_delete_extW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_extW';
function ldap_delete_ext; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_extA';
function ldap_delete_ext_sA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_ext_sA';
function ldap_delete_ext_sW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_ext_sW';
function ldap_delete_ext_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_delete_ext_sA';
function ldap_parse_resultA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_resultA';
function ldap_parse_resultW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_resultW';
function ldap_parse_result; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_resultA';
function ldap_controls_freeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_controls_freeA';
function ldap_controls_freeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_controls_freeW';
function ldap_controls_free; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_controls_freeA';
function ldap_parse_extended_resultA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_extended_resultA';
function ldap_parse_extended_resultW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_extended_resultW';
function ldap_parse_extended_result; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_extended_resultA';
function ldap_control_freeA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_control_freeA';
function ldap_control_freeW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_control_freeW';
function ldap_control_free; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_control_freeA';
function ldap_free_controlsA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_free_controlsA';
function ldap_free_controlsW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_free_controlsW';
function ldap_free_controls; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_free_controlsA';
function ldap_create_sort_controlA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_sort_controlA';
function ldap_create_sort_controlW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_sort_controlW';
function ldap_create_sort_control; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_sort_controlA';
function ldap_parse_sort_controlA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_sort_controlA';
function ldap_parse_sort_controlW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_sort_controlW';
function ldap_parse_sort_control; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_sort_controlA';
function ldap_encode_sort_controlA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_encode_sort_controlA';
function ldap_encode_sort_controlW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_encode_sort_controlW';
function ldap_encode_sort_control; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_encode_sort_controlA';
function ldap_create_page_controlA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_page_controlA';
function ldap_create_page_controlW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_page_controlW';
function ldap_create_page_control; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_create_page_controlA';
function ldap_parse_page_controlA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_page_controlA';
function ldap_parse_page_controlW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_page_controlW';
function ldap_parse_page_control; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_page_controlA';
function ldap_search_init_pageA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_init_pageA';
function ldap_search_init_pageW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_init_pageW';
function ldap_search_init_page; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_init_pageA';
function ldap_parse_referenceA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_referenceA';
function ldap_parse_referenceW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_referenceW';
function ldap_parse_reference; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_parse_referenceA';
function ldap_extended_operationA; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_extended_operationA';
function ldap_extended_operationW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_extended_operationW';
function ldap_extended_operation; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_extended_operationA';
function ldap_unbind; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_unbind';
function ldap_unbind_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_unbind_s';
function ldap_get_option; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_option';
function ldap_set_option; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_set_option';
function ldap_get_optionW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_optionW';
function ldap_set_optionW; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_set_optionW';
function ldap_abandon; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_abandon';
function ldap_result; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_result';
function ldap_msgfree; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_msgfree';
function ldap_result2error; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_result2error';
procedure ldap_perror; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_perror';
function ldap_first_entry; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_first_entry';
function ldap_next_entry; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_next_entry';
function ldap_count_entries; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_entries';
function ldap_count_values_len; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_values_len';
function ldap_value_free_len; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_value_free_len';
function ldap_startup; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_startup';
function ldap_cleanup; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_cleanup';
function ldap_set_dbg_flags; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_set_dbg_flags';
function ldap_connect; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_connect';
procedure ber_bvfree; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ber_bvfree';
procedure ldap_set_dbg_routine; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_set_dbg_routine';
function LdapUTF8ToUnicode; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LdapUTF8ToUnicode';
function LdapUnicodeToUTF8; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LdapUnicodeToUTF8';
function ldap_get_next_page; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_next_page';
function ldap_get_next_page_s; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_next_page_s';
function ldap_get_paged_count; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_get_paged_count';
function ldap_search_abandon_page; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_search_abandon_page';
function ldap_first_reference; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_first_reference';
function ldap_next_reference; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_next_reference';
function ldap_count_references; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_count_references';
function ldap_close_extended_op; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_close_extended_op';
function LdapGetLastError; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LdapGetLastError';
function LdapMapErrorToWin32; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LdapMapErrorToWin32';
function ldap_conn_from_msg; external LDAPLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ldap_conn_from_msg';
