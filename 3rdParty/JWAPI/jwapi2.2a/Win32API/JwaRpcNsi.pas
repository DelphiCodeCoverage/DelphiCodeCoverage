...
function RpcNsBindingExportA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExportA';
function RpcNsBindingExportW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExportW';
function RpcNsBindingExport; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExport' + AWSuffix;
function RpcNsBindingUnexportA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexportA';
function RpcNsBindingUnexportW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexportW';
function RpcNsBindingUnexport; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexport' + AWSuffix;
function RpcNsBindingExportPnPA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExportPnPA';
function RpcNsBindingExportPnPW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExportPnPW';
function RpcNsBindingExportPnP; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingExportPnP' + AWSuffix;
function RpcNsBindingUnexportPnPA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexportPnPA';
function RpcNsBindingUnexportPnPW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexportPnPW';
function RpcNsBindingUnexportPnP; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingUnexportPnP' + AWSuffix;
function RpcNsBindingLookupBeginA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingLookupBeginA';
function RpcNsBindingLookupBeginW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingLookupBeginW';
function RpcNsBindingLookupBegin; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingLookupBegin' + AWSuffix;
function RpcNsBindingLookupNext; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingLookupNext';
function RpcNsBindingLookupDone; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingLookupDone';
function RpcNsGroupDeleteA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupDeleteA';
function RpcNsGroupDeleteW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupDeleteW';
function RpcNsGroupDelete; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupDelete' + AWSuffix;
function RpcNsGroupMbrAddA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrAddA';
function RpcNsGroupMbrAddW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrAddW';
function RpcNsGroupMbrAdd; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrAdd' + AWSuffix;
function RpcNsGroupMbrRemoveA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrRemoveA';
function RpcNsGroupMbrRemoveW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrRemoveW';
function RpcNsGroupMbrRemove; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrRemove' + AWSuffix;
function RpcNsGroupMbrInqBeginA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqBeginA';
function RpcNsGroupMbrInqBeginW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqBeginW';
function RpcNsGroupMbrInqBegin; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqBegin' + AWSuffix;
function RpcNsGroupMbrInqNextA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqNextA';
function RpcNsGroupMbrInqNextW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqNextW';
function RpcNsGroupMbrInqNext; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqNext' + AWSuffix;
function RpcNsGroupMbrInqDone; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsGroupMbrInqDone';
function RpcNsProfileDeleteA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileDeleteA';
function RpcNsProfileDeleteW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileDeleteW';
function RpcNsProfileDelete; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileDelete' + AWSuffix;
function RpcNsProfileEltAddA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltAddA';
function RpcNsProfileEltAddW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltAddW';
function RpcNsProfileEltAdd; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltAdd' + AWSuffix;
function RpcNsProfileEltRemoveA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltRemoveA';
function RpcNsProfileEltRemoveW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltRemoveW';
function RpcNsProfileEltRemove; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltRemove' + AWSuffix;
function RpcNsProfileEltInqBeginA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqBeginA';
function RpcNsProfileEltInqBeginW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqBeginW';
function RpcNsProfileEltInqBegin; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqBegin' + AWSuffix;
function RpcNsProfileEltInqNextA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqNextA';
function RpcNsProfileEltInqNextW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqNextW';
function RpcNsProfileEltInqNext; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqNext' + AWSuffix;
function RpcNsProfileEltInqDone; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsProfileEltInqDone';
function RpcNsEntryObjectInqBeginA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryObjectInqBeginA';
function RpcNsEntryObjectInqBeginW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryObjectInqBeginW';
function RpcNsEntryObjectInqBegin; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryObjectInqBegin' + AWSuffix;
function RpcNsEntryObjectInqNext; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryObjectInqNext';
function RpcNsEntryObjectInqDone; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryObjectInqDone';
function RpcNsEntryExpandNameA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryExpandNameA';
function RpcNsEntryExpandNameW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryExpandNameW';
function RpcNsEntryExpandName; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsEntryExpandName' + AWSuffix;
function RpcNsMgmtBindingUnexportA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtBindingUnexportA';
function RpcNsMgmtBindingUnexportW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtBindingUnexportW';
function RpcNsMgmtBindingUnexport; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtBindingUnexport' + AWSuffix;
function RpcNsMgmtEntryCreateA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryCreateA';
function RpcNsMgmtEntryCreateW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryCreateW';
function RpcNsMgmtEntryCreate; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryCreate' + AWSuffix;
function RpcNsMgmtEntryDeleteA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryDeleteA';
function RpcNsMgmtEntryDeleteW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryDeleteW';
function RpcNsMgmtEntryDelete; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryDelete' + AWSuffix;
function RpcNsMgmtEntryInqIfIdsA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryInqIfIdsA';
function RpcNsMgmtEntryInqIfIdsW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryInqIfIdsW';
function RpcNsMgmtEntryInqIfIds; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtEntryInqIfIds' + AWSuffix;
function RpcNsMgmtHandleSetExpAge; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtHandleSetExpAge';
function RpcNsMgmtInqExpAge; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtInqExpAge';
function RpcNsMgmtSetExpAge; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsMgmtSetExpAge';
function RpcNsBindingImportBeginA; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingImportBeginA';
function RpcNsBindingImportBeginW; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingImportBeginW';
function RpcNsBindingImportBegin; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingImportBegin' + AWSuffix;
function RpcNsBindingImportNext; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingImportNext';
function RpcNsBindingImportDone; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingImportDone';
function RpcNsBindingSelect; external rpcns4 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RpcNsBindingSelect';
