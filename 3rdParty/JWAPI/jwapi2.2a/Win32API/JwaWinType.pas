...
//
  ...
  UCHAR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.UCHAR {$ELSE} Byte {$ENDIF};
  {$EXTERNALSYM UCHAR}
  USHORT = Word;
  {$EXTERNALSYM USHORT}
  ULONG = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.ULONG {$ELSE} Cardinal {$ENDIF};
  {$EXTERNALSYM ULONG}
  UQUAD = QUAD;
  {$EXTERNALSYM UQUAD}
...
type
  ...
  {$IFDEF USE_DELPHI_TYPES}
  ULONGLONG = {$IFDEF COMPILER12_UP} Winapi.Windows.ULONGLONG {$ELSE} UInt64 {$ENDIF};
  {$ELSE}
  ULONGLONG = UInt64;
  {$ENDIF}
...
//
  ...
  PWCHAR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.PWChar {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PWCHAR}
  LPWCH = ^WCHAR;
  {$EXTERNALSYM LPWCH}
  PWCH = ^WCHAR;
  ...
  NWPSTR = ^WCHAR;
  {$EXTERNALSYM NWPSTR}
  LPWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPWSTR}
  LPCWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPCWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPCWSTR}
  PWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PWSTR}
  LPUWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPUWSTR}
  PUWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PUWSTR}
{$IFDEF JWA_USE_INCORRECT_IDENTIFIERS}
  LCPUWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF}; //This type does not exist in original headers
{$ENDIF}
  LPCUWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPCUWSTR}
  PCUWSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PCUWSTR}
...
//
  ...
  NPSTR = ^AnsiChar;
  {$EXTERNALSYM NPSTR}
  LPSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPSTR {$ELSE} PAnsiChar {$ENDIF};
  {$EXTERNALSYM LPSTR}
  PSTR = PAnsiChar;
  {$EXTERNALSYM PSTR}
  LPCSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPCSTR {$ELSE} PAnsiChar {$ENDIF};
  {$EXTERNALSYM LPCSTR}
  PCSTR = PAnsiChar;
  {$EXTERNALSYM PCSTR}
...
{$IFDEF UNICODE}
  ...
  PTSTR = LPWSTR;
  {$EXTERNALSYM PTSTR}
  LPTSTR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LPWSTR {$ELSE} LPWSTR {$ENDIF};
  {$EXTERNALSYM LPTSTR}
  PCTSTR = LPTSTR;
  {$EXTERNALSYM PCTSTR}
  LPCTSTR = LPTSTR;
...
//
  ...
  PUCHAR = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.PUCHAR {$ELSE} ^Byte {$ENDIF};
  {$EXTERNALSYM PUCHAR}
  PUSHORT = ^USHORT;
  {$EXTERNALSYM PUSHORT}
...
//
  ...
  LCID = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LCID {$ELSE} DWORD {$ENDIF};
  {$EXTERNALSYM LCID}
  PLCID = ^LCID;
  {$EXTERNALSYM PLCID}
  LANGID = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.LANGID {$ELSE} Word {$ENDIF};
  {$EXTERNALSYM LANGID}
...
//
  ...
  {$IFDEF USE_DELPHI_TYPES}
  INT_PTR = {$IFDEF COMPILER12_UP} Winapi.Windows.INT_PTR {$ELSE} SizeInt {$ENDIF};
  {$ELSE}
  INT_PTR = SizeInt;
  {$ENDIF}
  {$EXTERNALSYM INT_PTR}
  ...
  {$IFDEF USE_DELPHI_TYPES}
  LONG_PTR = {$IFDEF COMPILER12_UP} Winapi.Windows.LONG_PTR {$ELSE} SizeInt {$ENDIF};
  {$ELSE}
  LONG_PTR = SizeInt;
  {$ENDIF}
...
//
  ...
  {$IFDEF USE_DELPHI_TYPES}
  UINT_PTR = {$IFDEF COMPILER12_UP} Winapi.Windows.UINT_PTR {$ELSE} SizeUInt {$ENDIF};
  {$ELSE}
  UINT_PTR = SizeUInt;
  {$ENDIF}
  ...
  {$IFDEF USE_DELPHI_TYPES}
  ULONG_PTR = {$IFDEF COMPILER12_UP} Winapi.Windows.ULONG_PTR {$ELSE} SizeUInt {$ENDIF};
  {$ELSE}
  ULONG_PTR = SizeUInt;
  {$ENDIF}
...
type
  ...
  FARPROC = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.FARPROC {$ELSE} function: Integer; stdcall {$ENDIF};
  {$EXTERNALSYM FARPROC}
  ...
  HINST = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.HINST {$ELSE} HANDLE {$ENDIF};

  HMODULE = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.HMODULE {$ELSE} HINST {$ENDIF};
  {$EXTERNALSYM HMODULE}
  ...
  HFILE = {$IFDEF USE_DELPHI_TYPES} Winapi.Windows.HFILE {$ELSE} Longword {$ENDIF};
  {$EXTERNALSYM HFILE}
...
type
  ...
  {$IFDEF USE_DELPHI_TYPES}
  HANDLE_PTR = {$IFDEF COMPILER16_UP} Winapi.Windows.HANDLE_PTR {$ELSE} SizeUInt {$ENDIF};
  {$ELSE}
  HANDLE_PTR = SizeUInt; // Up to XE2, Winapi.Windows.HANDLE_PTR doesn't exist
  {$ENDIF}
