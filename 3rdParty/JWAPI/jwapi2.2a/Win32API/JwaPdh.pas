...
function PdhGetDllVersion; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDllVersion';
function PdhOpenQueryA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenQueryA';
function PdhOpenQueryW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenQueryW';
function PdhOpenQuery; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenQuery' + AWSuffix;
function PdhAddCounterA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhAddCounterA';
function PdhAddCounterW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhAddCounterW';
function PdhAddCounter; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhAddCounter' + AWSuffix;
function PdhRemoveCounter; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhRemoveCounter';
function PdhCollectQueryData; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCollectQueryData';
function PdhCloseQuery; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCloseQuery';
function PdhGetFormattedCounterValue; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetFormattedCounterValue';
function PdhGetFormattedCounterArrayA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetFormattedCounterArrayA';
function PdhGetFormattedCounterArrayW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetFormattedCounterArrayW';
function PdhGetFormattedCounterArray; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetFormattedCounterArray' + AWSuffix;
function PdhGetRawCounterValue; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetRawCounterValue';
function PdhGetRawCounterArrayA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetRawCounterArrayA';
function PdhGetRawCounterArrayW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetRawCounterArrayW';
function PdhGetRawCounterArray; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetRawCounterArray' + AWSuffix;
function PdhCalculateCounterFromRawValue; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCalculateCounterFromRawValue';
function PdhComputeCounterStatistics; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhComputeCounterStatistics';
function PdhGetCounterInfoA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetCounterInfoA';
function PdhGetCounterInfoW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetCounterInfoW';
function PdhGetCounterInfo; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetCounterInfo' + AWSuffix;
function PdhSetCounterScaleFactor; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSetCounterScaleFactor';
function PdhConnectMachineA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhConnectMachineA';
function PdhConnectMachineW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhConnectMachineW';
function PdhConnectMachine; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhConnectMachine' + AWSuffix;
function PdhEnumMachinesA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachinesA';
function PdhEnumMachinesW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachinesW';
function PdhEnumMachines; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachines' + AWSuffix;
function PdhEnumObjectsA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectsA';
function PdhEnumObjectsW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectsW';
function PdhEnumObjects; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjects' + AWSuffix;
function PdhEnumObjectItemsA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItemsA';
function PdhEnumObjectItemsW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItemsW';
function PdhEnumObjectItems; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItems' + AWSuffix;
function PdhMakeCounterPathA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhMakeCounterPathA';
function PdhMakeCounterPathW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhMakeCounterPathW';
function PdhMakeCounterPath; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhMakeCounterPath' + AWSuffix;
function PdhParseCounterPathA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseCounterPathA';
function PdhParseCounterPathW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseCounterPathW';
function PdhParseCounterPath; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseCounterPath' + AWSuffix;
function PdhParseInstanceNameA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseInstanceNameA';
function PdhParseInstanceNameW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseInstanceNameW';
function PdhParseInstanceName; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhParseInstanceName' + AWSuffix;
function PdhValidatePathA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhValidatePathA';
function PdhValidatePathW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhValidatePathW';
function PdhValidatePath; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhValidatePath' + AWSuffix;
function PdhGetDefaultPerfObjectA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObjectA';
function PdhGetDefaultPerfObjectW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObjectW';
function PdhGetDefaultPerfObject; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObject' + AWSuffix;
function PdhGetDefaultPerfCounterA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounterA';
function PdhGetDefaultPerfCounterW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounterW';
function PdhGetDefaultPerfCounter; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounter' + AWSuffix;
function PdhBrowseCountersA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCountersA';
function PdhBrowseCountersW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCountersW';
function PdhBrowseCounters; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCounters' + AWSuffix;
function PdhExpandCounterPathA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandCounterPathA';
function PdhExpandCounterPathW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandCounterPathW';
function PdhExpandCounterPath; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandCounterPath' + AWSuffix;
function PdhLookupPerfNameByIndexA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfNameByIndexA';
function PdhLookupPerfNameByIndexW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfNameByIndexW';
function PdhLookupPerfNameByIndex; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfNameByIndex' + AWSuffix;
function PdhLookupPerfIndexByNameA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfIndexByNameA';
function PdhLookupPerfIndexByNameW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfIndexByNameW';
function PdhLookupPerfIndexByName; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhLookupPerfIndexByName' + AWSuffix;
function PdhExpandWildCardPathA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPathA';
function PdhExpandWildCardPathW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPathW';
function PdhExpandWildCardPath; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPath' + AWSuffix;
function PdhOpenLogA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenLogA';
function PdhOpenLogW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenLogW';
function PdhOpenLog; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenLog' + AWSuffix;
function PdhUpdateLogA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhUpdateLogA';
function PdhUpdateLogW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhUpdateLogW';
function PdhUpdateLog; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhUpdateLog' + AWSuffix;
function PdhUpdateLogFileCatalog; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhUpdateLogFileCatalog';
function PdhGetLogFileSize; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetLogFileSize';
function PdhCloseLog; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCloseLog';
function PdhSelectDataSourceA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSelectDataSourceA';
function PdhSelectDataSourceW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSelectDataSourceW';
function PdhSelectDataSource; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSelectDataSource' + AWSuffix;
function PdhIsRealTimeQuery; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhIsRealTimeQuery';
function PdhSetQueryTimeRange; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSetQueryTimeRange';
function PdhGetDataSourceTimeRangeA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDataSourceTimeRangeA';
function PdhGetDataSourceTimeRangeW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDataSourceTimeRangeW';
function PdhGetDataSourceTimeRange; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDataSourceTimeRange' + AWSuffix;
function PdhCollectQueryDataEx; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCollectQueryDataEx';
function PdhFormatFromRawValue; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhFormatFromRawValue';
function PdhGetCounterTimeBase; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetCounterTimeBase';
function PdhReadRawLogRecord; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhReadRawLogRecord';
function PdhSetDefaultRealTimeDataSource; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSetDefaultRealTimeDataSource';
function PdhBindInputDataSourceW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBindInputDataSourceW';
function PdhBindInputDataSourceA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBindInputDataSourceA';
function PdhBindInputDataSource; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBindInputDataSource' + AWSuffix;
function PdhOpenQueryH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhOpenQueryH';
function PdhEnumMachinesHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachinesHW';
function PdhEnumMachinesHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachinesHA';
function PdhEnumMachinesH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumMachinesH' + AWSuffix;
function PdhEnumObjectsHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectsHW';
function PdhEnumObjectsHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectsHA';
function PdhEnumObjectsH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectsH' + AWSuffix;
function PdhEnumObjectItemsHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItemsHW';
function PdhEnumObjectItemsHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItemsHA';
function PdhEnumObjectItemsH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumObjectItemsH' + AWSuffix;
function PdhExpandWildCardPathHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPathHW';
function PdhExpandWildCardPathHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPathHA';
function PdhExpandWildCardPathH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhExpandWildCardPathH' + AWSuffix;
function PdhGetDataSourceTimeRangeH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDataSourceTimeRangeH';
function PdhGetDefaultPerfObjectHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObjectHW';
function PdhGetDefaultPerfObjectHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObjectHA';
function PdhGetDefaultPerfObjectH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfObjectH' + AWSuffix;
function PdhGetDefaultPerfCounterHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounterHW';
function PdhGetDefaultPerfCounterHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounterHA';
function PdhGetDefaultPerfCounterH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetDefaultPerfCounterH' + AWSuffix;
function PdhBrowseCountersHW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCountersHW';
function PdhBrowseCountersHA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCountersHA';
function PdhBrowseCountersH; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhBrowseCountersH' + AWSuffix;
function PdhVerifySQLDBW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhVerifySQLDBW';
function PdhVerifySQLDBA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhVerifySQLDBA';
function PdhVerifySQLDB; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhVerifySQLDB' + AWSuffix;
function PdhCreateSQLTablesW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCreateSQLTablesW';
function PdhCreateSQLTablesA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCreateSQLTablesA';
function PdhCreateSQLTables; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhCreateSQLTables' + AWSuffix;
function PdhEnumLogSetNamesW; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumLogSetNamesW';
function PdhEnumLogSetNamesA; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumLogSetNamesA';
function PdhEnumLogSetNames; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhEnumLogSetNames' + AWSuffix;
function PdhGetLogSetGUID; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhGetLogSetGUID';
function PdhSetLogSetRunID; external PdhLib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PdhSetLogSetRunID';
