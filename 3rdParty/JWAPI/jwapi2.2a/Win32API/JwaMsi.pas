...
function MsiCloseHandle; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCloseHandle';
function MsiCloseAllHandles; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCloseAllHandles';
function MsiSetInternalUI; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetInternalUI';
function MsiSetExternalUIA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetExternalUIA';
function MsiSetExternalUIW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetExternalUIW';
function MsiSetExternalUI; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSetExternalUI' + AWSuffix;
function MsiEnableLogA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnableLogA';
function MsiEnableLogW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnableLogW';
function MsiEnableLog; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnableLog' + AWSuffix;
function MsiQueryProductStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryProductStateA';
function MsiQueryProductStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryProductStateW';
function MsiQueryProductState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryProductState' + AWSuffix;
function MsiGetProductInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfoA';
function MsiGetProductInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfoW';
function MsiGetProductInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfo' + AWSuffix;
function MsiInstallProductA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallProductA';
function MsiInstallProductW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallProductW';
function MsiInstallProduct; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallProduct' + AWSuffix;
function MsiConfigureProductA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProductA';
function MsiConfigureProductW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProductW';
function MsiConfigureProduct; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProduct' + AWSuffix;
function MsiConfigureProductExA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProductExA';
function MsiConfigureProductExW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProductExW';
function MsiConfigureProductEx; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureProductEx' + AWSuffix;
function MsiReinstallProductA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallProductA';
function MsiReinstallProductW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallProductW';
function MsiReinstallProduct; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallProduct' + AWSuffix;
function MsiAdvertiseProductExA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProductExA';
function MsiAdvertiseProductExW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProductExW';
function MsiAdvertiseProductEx; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProductEx' + AWSuffix;
function MsiAdvertiseProductA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProductA';
function MsiAdvertiseProductW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProductW';
function MsiAdvertiseProduct; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseProduct' + AWSuffix;
function MsiProcessAdvertiseScriptA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProcessAdvertiseScriptA';
function MsiProcessAdvertiseScriptW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProcessAdvertiseScriptW';
function MsiProcessAdvertiseScript; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProcessAdvertiseScript' + AWSuffix;
function MsiAdvertiseScriptA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseScriptA';
function MsiAdvertiseScriptW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseScriptW';
function MsiAdvertiseScript; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiAdvertiseScript' + AWSuffix;
function MsiGetProductInfoFromScriptA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfoFromScriptA';
function MsiGetProductInfoFromScriptW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfoFromScriptW';
function MsiGetProductInfoFromScript; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductInfoFromScript' + AWSuffix;
function MsiGetProductCodeA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductCodeA';
function MsiGetProductCodeW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductCodeW';
function MsiGetProductCode; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductCode' + AWSuffix;
function MsiGetUserInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetUserInfoA';
function MsiGetUserInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetUserInfoW';
function MsiGetUserInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetUserInfo' + AWSuffix;
function MsiCollectUserInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCollectUserInfoA';
function MsiCollectUserInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCollectUserInfoW';
function MsiCollectUserInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiCollectUserInfo' + AWSuffix;
function MsiApplyPatchA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiApplyPatchA';
function MsiApplyPatchW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiApplyPatchW';
function MsiApplyPatch; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiApplyPatch' + AWSuffix;
function MsiGetPatchInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetPatchInfoA';
function MsiGetPatchInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetPatchInfoW';
function MsiGetPatchInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetPatchInfo' + AWSuffix;
function MsiEnumPatchesA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumPatchesA';
function MsiEnumPatchesW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumPatchesW';
function MsiEnumPatches; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumPatches' + AWSuffix;
function MsiQueryFeatureStateA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryFeatureStateA';
function MsiQueryFeatureStateW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryFeatureStateW';
function MsiQueryFeatureState; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiQueryFeatureState' + AWSuffix;
function MsiUseFeatureA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeatureA';
function MsiUseFeatureW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeatureW';
function MsiUseFeature; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeature' + AWSuffix;
function MsiUseFeatureExA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeatureExA';
function MsiUseFeatureExW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeatureExW';
function MsiUseFeatureEx; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiUseFeatureEx' + AWSuffix;
function MsiGetFeatureUsageA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureUsageA';
function MsiGetFeatureUsageW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureUsageW';
function MsiGetFeatureUsage; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureUsage' + AWSuffix;
function MsiConfigureFeatureA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureFeatureA';
function MsiConfigureFeatureW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureFeatureW';
function MsiConfigureFeature; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiConfigureFeature' + AWSuffix;
function MsiReinstallFeatureA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallFeatureA';
function MsiReinstallFeatureW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallFeatureW';
function MsiReinstallFeature; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiReinstallFeature' + AWSuffix;
function MsiProvideComponentA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideComponentA';
function MsiProvideComponentW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideComponentW';
function MsiProvideComponent; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideComponent' + AWSuffix;
function MsiProvideQualifiedComponentA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponentA';
function MsiProvideQualifiedComponentW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponentW';
function MsiProvideQualifiedComponent; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponent' + AWSuffix;
function MsiProvideQualifiedComponentExA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponentExA';
function MsiProvideQualifiedComponentExW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponentExW';
function MsiProvideQualifiedComponentEx; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideQualifiedComponentEx' + AWSuffix;
function MsiGetComponentPathA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentPathA';
function MsiGetComponentPathW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentPathW';
function MsiGetComponentPath; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetComponentPath' + AWSuffix;
function MsiProvideAssemblyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideAssemblyA';
function MsiProvideAssemblyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideAssemblyW';
function MsiProvideAssembly; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiProvideAssembly' + AWSuffix;
function MsiEnumProductsA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumProductsA';
function MsiEnumProductsW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumProductsW';
function MsiEnumProducts; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumProducts' + AWSuffix;
{$IFDEF MSI110}
function MsiEnumRelatedProductsA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumRelatedProductsA';
function MsiEnumRelatedProductsW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumRelatedProductsW';
function MsiEnumRelatedProducts; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumRelatedProducts' + AWSuffix;
{$ENDIF MSI110}
function MsiEnumFeaturesA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumFeaturesA';
function MsiEnumFeaturesW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumFeaturesW';
function MsiEnumFeatures; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumFeatures' + AWSuffix;
function MsiEnumComponentsA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentsA';
function MsiEnumComponentsW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentsW';
function MsiEnumComponents; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponents' + AWSuffix;
function MsiEnumClientsA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumClientsA';
function MsiEnumClientsW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumClientsW';
function MsiEnumClients; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumClients' + AWSuffix;
function MsiEnumComponentQualifiersA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentQualifiersA';
function MsiEnumComponentQualifiersW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentQualifiersW';
function MsiEnumComponentQualifiers; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiEnumComponentQualifiers' + AWSuffix;
function MsiOpenProductA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenProductA';
function MsiOpenProductW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenProductW';
function MsiOpenProduct; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenProduct' + AWSuffix;
function MsiOpenPackageA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackageA';
function MsiOpenPackageW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackageW';
function MsiOpenPackage; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackage' + AWSuffix;
function MsiOpenPackageExA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackageExA';
function MsiOpenPackageExW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackageExW';
function MsiOpenPackageEx; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiOpenPackageEx' + AWSuffix;
function MsiGetProductPropertyA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductPropertyA';
function MsiGetProductPropertyW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductPropertyW';
function MsiGetProductProperty; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetProductProperty' + AWSuffix;
function MsiVerifyPackageA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiVerifyPackageA';
function MsiVerifyPackageW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiVerifyPackageW';
function MsiVerifyPackage; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiVerifyPackage' + AWSuffix;
function MsiGetFeatureInfoA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureInfoA';
function MsiGetFeatureInfoW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureInfoW';
function MsiGetFeatureInfo; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFeatureInfo' + AWSuffix;
function MsiInstallMissingComponentA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingComponentA';
function MsiInstallMissingComponentW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingComponentW';
function MsiInstallMissingComponent; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingComponent' + AWSuffix;
function MsiInstallMissingFileA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingFileA';
function MsiInstallMissingFileW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingFileW';
function MsiInstallMissingFile; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiInstallMissingFile' + AWSuffix;
function MsiLocateComponentA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiLocateComponentA';
function MsiLocateComponentW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiLocateComponentW';
function MsiLocateComponent; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiLocateComponent' + AWSuffix;
{$IFDEF MSI110}
function MsiSourceListClearAllA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListClearAllA';
function MsiSourceListClearAllW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListClearAllW';
function MsiSourceListClearAll; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListClearAll' + AWSuffix;
function MsiSourceListAddSourceA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListAddSourceA';
function MsiSourceListAddSourceW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListAddSourceW';
function MsiSourceListAddSource; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListAddSource' + AWSuffix;
function MsiSourceListForceResolutionA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListForceResolutionA';
function MsiSourceListForceResolutionW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListForceResolutionW';
function MsiSourceListForceResolution; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiSourceListForceResolution' + AWSuffix;
{$ENDIF MSI110}
function MsiGetFileVersionA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileVersionA';
function MsiGetFileVersionW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileVersionW';
function MsiGetFileVersion; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileVersion' + AWSuffix;
function MsiGetFileHashA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileHashA';
function MsiGetFileHashW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileHashW';
function MsiGetFileHash; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileHash' + AWSuffix;
function MsiGetFileSignatureInformationA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileSignatureInformationA';
function MsiGetFileSignatureInformationW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileSignatureInformationW';
function MsiGetFileSignatureInformation; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetFileSignatureInformation' + AWSuffix;
{$IFDEF MSI110}
function MsiGetShortcutTargetA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetShortcutTargetA';
function MsiGetShortcutTargetW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetShortcutTargetW';
function MsiGetShortcutTarget; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiGetShortcutTarget' + AWSuffix;
{$ENDIF MSI110}
function MsiIsProductElevatedA; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiIsProductElevatedA';
function MsiIsProductElevatedW; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiIsProductElevatedW';
function MsiIsProductElevated; external msilib {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsiIsProductElevated' + AWSuffix;
