...
function IsHungAppWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsHungAppWindow';
procedure DisableProcessWindowsGhosting; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DisableProcessWindowsGhosting';
function wvsprintfA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wvsprintfA';
function wvsprintfW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wvsprintfW';
function wvsprintf; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wvsprintf' + AWSuffix;
function wsprintfA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wsprintfA';
function wsprintfW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wsprintfW';
function wsprintf; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'wsprintf' + AWSuffix;
function LoadKeyboardLayoutA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadKeyboardLayoutA';
function LoadKeyboardLayoutW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadKeyboardLayoutW';
function LoadKeyboardLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadKeyboardLayout' + AWSuffix;
function ActivateKeyboardLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ActivateKeyboardLayout';
function ToUnicodeEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ToUnicodeEx';
function UnloadKeyboardLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnloadKeyboardLayout';
function GetKeyboardLayoutNameA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardLayoutNameA';
function GetKeyboardLayoutNameW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardLayoutNameW';
function GetKeyboardLayoutName; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardLayoutName' + AWSuffix;
function GetKeyboardLayoutList; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardLayoutList';
function GetKeyboardLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardLayout';
function GetMouseMovePointsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMouseMovePointsEx';
function CreateDesktopA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDesktopA';
function CreateDesktopW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDesktopW';
function CreateDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDesktop' + AWSuffix;
function OpenDesktopA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenDesktopA';
function OpenDesktopW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenDesktopW';
function OpenDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenDesktop' + AWSuffix;
function OpenInputDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenInputDesktop';
function EnumDesktopsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDesktopsA';
function EnumDesktopsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDesktopsW';
function EnumDesktops; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDesktops' + AWSuffix;
function EnumDesktopWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDesktopWindows';
function SwitchDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SwitchDesktop';
function SetThreadDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetThreadDesktop';
function CloseDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseDesktop';
function GetThreadDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetThreadDesktop';
function CreateWindowStationA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowStationA';
function CreateWindowStationW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowStationW';
function CreateWindowStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowStation' + AWSuffix;
function OpenWindowStationA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenWindowStationA';
function OpenWindowStationW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenWindowStationW';
function OpenWindowStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenWindowStation' + AWSuffix;
function EnumWindowStationsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumWindowStationsA';
function EnumWindowStationsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumWindowStationsW';
function EnumWindowStations; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumWindowStations' + AWSuffix;
function CloseWindowStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseWindowStation';
function SetProcessWindowStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetProcessWindowStation';
function GetProcessWindowStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetProcessWindowStation';
function SetUserObjectSecurity; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetUserObjectSecurity';
function GetUserObjectSecurity; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUserObjectSecurity';
function GetUserObjectInformationA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUserObjectInformationA';
function GetUserObjectInformationW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUserObjectInformationW';
function GetUserObjectInformation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUserObjectInformation' + AWSuffix;
function SetUserObjectInformationA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetUserObjectInformationA';
function SetUserObjectInformationW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetUserObjectInformationW';
function SetUserObjectInformation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetUserObjectInformation' + AWSuffix;
function RegisterWindowMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterWindowMessageA';
function RegisterWindowMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterWindowMessageW';
function RegisterWindowMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterWindowMessage' + AWSuffix;
function TrackMouseEvent; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TrackMouseEvent';
function DrawEdge; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawEdge';
function DrawFrameControl; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawFrameControl';
function DrawCaption; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawCaption';
function DrawAnimatedRects; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawAnimatedRects';
function GetMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessageA';
function GetMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessageW';
function GetMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessage' + AWSuffix;
function TranslateMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateMessage';
function DispatchMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DispatchMessageA';
function DispatchMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DispatchMessageW';
function DispatchMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DispatchMessage' + AWSuffix;
function SetMessageQueue; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMessageQueue';
function PeekMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PeekMessageA';
function PeekMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PeekMessageW';
function PeekMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PeekMessage' + AWSuffix;
function RegisterHotKey; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterHotKey';
function UnregisterHotKey; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnregisterHotKey';
function ExitWindowsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExitWindowsEx';
function SwapMouseButton; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SwapMouseButton';
function GetMessagePos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessagePos';
function GetMessageTime; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessageTime';
function GetMessageExtraInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMessageExtraInfo';
function SetMessageExtraInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMessageExtraInfo';
function SendMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageA';
function SendMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageW';
function SendMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessage' + AWSuffix;
function SendMessageTimeoutA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageTimeoutA';
function SendMessageTimeoutW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageTimeoutW';
function SendMessageTimeout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageTimeout' + AWSuffix;
function SendNotifyMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendNotifyMessageA';
function SendNotifyMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendNotifyMessageW';
function SendNotifyMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendNotifyMessage' + AWSuffix;
function SendMessageCallbackA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageCallbackA';
function SendMessageCallbackW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageCallbackW';
function SendMessageCallback; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendMessageCallback' + AWSuffix;
function BroadcastSystemMessageExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessageExA';
function BroadcastSystemMessageExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessageExW';
function BroadcastSystemMessageEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessageEx' + AWSuffix;
function BroadcastSystemMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessageA';
function BroadcastSystemMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessageW';
function BroadcastSystemMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BroadcastSystemMessage' + AWSuffix;
function RegisterDeviceNotificationA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterDeviceNotificationA';
...
function PostThreadMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PostThreadMessageA';
function PostThreadMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PostThreadMessageW';
function PostThreadMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PostThreadMessage' + AWSuffix;
function AttachThreadInput; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AttachThreadInput';
function ReplyMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ReplyMessage';
function WaitMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WaitMessage';
function WaitForInputIdle; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WaitForInputIdle';
function DefWindowProcA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefWindowProcA';
function DefWindowProcW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefWindowProcW';
function DefWindowProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefWindowProc' + AWSuffix;
procedure PostQuitMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PostQuitMessage';
function CallWindowProcA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallWindowProcA';
function CallWindowProcW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallWindowProcW';
function CallWindowProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallWindowProc' + AWSuffix;
function InSendMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InSendMessage';
function InSendMessageEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InSendMessageEx';
function GetDoubleClickTime; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDoubleClickTime';
function SetDoubleClickTime; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDoubleClickTime';
function RegisterClassA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClassA';
function RegisterClassW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClassW';
function RegisterClass; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClass' + AWSuffix;
function UnregisterClassA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnregisterClassA';
function UnregisterClassW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnregisterClassW';
function UnregisterClass; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnregisterClass' + AWSuffix;
function GetClassInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfoA';
function GetClassInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfoW';
function GetClassInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfo' + AWSuffix;
function RegisterClassExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClassExA';
function RegisterClassExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClassExW';
function RegisterClassEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClassEx' + AWSuffix;
function GetClassInfoExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfoExA';
function GetClassInfoExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfoExW';
function GetClassInfoEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassInfoEx' + AWSuffix;
function CreateWindowExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowExA';
function CreateWindowExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowExW';
function CreateWindowEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateWindowEx' + AWSuffix;
function IsWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsWindow';
function IsMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsMenu';
function IsChild; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsChild';
function DestroyWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyWindow';
function ShowWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowWindow';
function AnimateWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AnimateWindow';
function UpdateLayeredWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateLayeredWindow';
function GetLayeredWindowAttributes; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLayeredWindowAttributes';
function PrintWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PrintWindow';
function SetLayeredWindowAttributes; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetLayeredWindowAttributes';
function ShowWindowAsync; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowWindowAsync';
function FlashWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FlashWindow';
function FlashWindowEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FlashWindowEx';
function ShowOwnedPopups; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowOwnedPopups';
function OpenIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenIcon';
function CloseWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseWindow';
function MoveWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MoveWindow';
function SetWindowPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowPos';
function GetWindowPlacement; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowPlacement';
function SetWindowPlacement; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowPlacement';
function BeginDeferWindowPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BeginDeferWindowPos';
function DeferWindowPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeferWindowPos';
function EndDeferWindowPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndDeferWindowPos';
function IsWindowVisible; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsWindowVisible';
function IsIconic; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsIconic';
function AnyPopup; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AnyPopup';
function BringWindowToTop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BringWindowToTop';
function IsZoomed; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsZoomed';
function CreateDialogParamA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogParamA';
function CreateDialogParamW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogParamW';
function CreateDialogParam; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogParam' + AWSuffix;
function CreateDialogIndirectParamA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogIndirectParamA';
function CreateDialogIndirectParamW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogIndirectParamW';
function CreateDialogIndirectParam; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateDialogIndirectParam' + AWSuffix;
function DialogBoxParamA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxParamA';
function DialogBoxParamW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxParamW';
function DialogBoxParam; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxParam' + AWSuffix;
function DialogBoxIndirectParamA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxIndirectParamA';
function DialogBoxIndirectParamW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxIndirectParamW';
function DialogBoxIndirectParam; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DialogBoxIndirectParam' + AWSuffix;
function EndDialog; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndDialog';
function GetDlgItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgItem';
function SetDlgItemInt; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDlgItemInt';
function GetDlgItemInt; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgItemInt';
function SetDlgItemTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDlgItemTextA';
function SetDlgItemTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDlgItemTextW';
function SetDlgItemText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDlgItemText' + AWSuffix;
function GetDlgItemTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgItemTextA';
function GetDlgItemTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgItemTextW';
function GetDlgItemText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgItemText' + AWSuffix;
function CheckDlgButton; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CheckDlgButton';
function CheckRadioButton; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CheckRadioButton';
function IsDlgButtonChecked; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsDlgButtonChecked';
function SendDlgItemMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendDlgItemMessageA';
function SendDlgItemMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendDlgItemMessageW';
function SendDlgItemMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SendDlgItemMessage' + AWSuffix;
function GetNextDlgGroupItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetNextDlgGroupItem';
function GetNextDlgTabItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetNextDlgTabItem';
function GetDlgCtrlID; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDlgCtrlID';
function GetDialogBaseUnits; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDialogBaseUnits';
function DefDlgProcA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefDlgProcA';
function DefDlgProcW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefDlgProcW';
function DefDlgProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefDlgProc' + AWSuffix;
function CallMsgFilterA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallMsgFilterA';
function CallMsgFilterW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallMsgFilterW';
function CallMsgFilter; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallMsgFilter' + AWSuffix;
function OpenClipboard; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OpenClipboard';
function CloseClipboard; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CloseClipboard';
function GetClipboardSequenceNumber; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardSequenceNumber';
function GetClipboardOwner; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardOwner';
function SetClipboardViewer; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClipboardViewer';
function GetClipboardViewer; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardViewer';
function ChangeClipboardChain; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeClipboardChain';
function SetClipboardData; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClipboardData';
function GetClipboardData; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardData';
function RegisterClipboardFormatA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClipboardFormatA';
function RegisterClipboardFormatW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClipboardFormatW';
function RegisterClipboardFormat; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterClipboardFormat' + AWSuffix;
function CountClipboardFormats; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CountClipboardFormats';
function EnumClipboardFormats; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumClipboardFormats';
function GetClipboardFormatNameA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardFormatNameA';
function GetClipboardFormatNameW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardFormatNameW';
function GetClipboardFormatName; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipboardFormatName' + AWSuffix;
function EmptyClipboard; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EmptyClipboard';
function IsClipboardFormatAvailable; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsClipboardFormatAvailable';
function GetPriorityClipboardFormat; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPriorityClipboardFormat';
function GetOpenClipboardWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetOpenClipboardWindow';
function CharToOemA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOemA';
function CharToOemW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOemW';
function CharToOem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOem' + AWSuffix;
function OemToCharA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToCharA';
function OemToCharW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToCharW';
function OemToChar; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToChar' + AWSuffix;
function CharToOemBuffA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOemBuffA';
function CharToOemBuffW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOemBuffW';
function CharToOemBuff; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharToOemBuff' + AWSuffix;
function OemToCharBuffA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToCharBuffA';
function OemToCharBuffW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToCharBuffW';
function OemToCharBuff; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemToCharBuff' + AWSuffix;
function CharUpperA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpperA';
function CharUpperW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpperW';
function CharUpper; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpper' + AWSuffix;
function CharUpperBuffA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpperBuffA';
function CharUpperBuffW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpperBuffW';
function CharUpperBuff; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharUpperBuff' + AWSuffix;
function CharLowerA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLowerA';
function CharLowerW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLowerW';
function CharLower; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLower' + AWSuffix;
function CharLowerBuffA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLowerBuffA';
function CharLowerBuffW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLowerBuffW';
function CharLowerBuff; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharLowerBuff' + AWSuffix;
function CharNextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharNextA';
function CharNextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharNextW';
function CharNext; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharNext' + AWSuffix;
function CharPrevA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharPrevA';
function CharPrevW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharPrevW';
function CharPrev; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharPrev' + AWSuffix;
function CharNextExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharNextExA';
function CharPrevExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CharPrevExA';
function IsCharAlphaA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlphaA';
function IsCharAlphaW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlphaW';
function IsCharAlpha; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlpha' + AWSuffix;
function IsCharAlphaNumericA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlphaNumericA';
function IsCharAlphaNumericW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlphaNumericW';
function IsCharAlphaNumeric; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharAlphaNumeric' + AWSuffix;
function IsCharUpperA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharUpperA';
function IsCharUpperW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharUpperW';
function IsCharUpper; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharUpper' + AWSuffix;
function IsCharLowerA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharLowerA';
function IsCharLowerW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharLowerW';
function IsCharLower; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsCharLower' + AWSuffix;
function SetFocus; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetFocus';
function GetActiveWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetActiveWindow';
function GetFocus; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetFocus';
function GetKBCodePage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKBCodePage';
function GetKeyState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyState';
function GetAsyncKeyState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAsyncKeyState';
function GetKeyboardState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardState';
function SetKeyboardState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetKeyboardState';
function GetKeyNameTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyNameTextA';
function GetKeyNameTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyNameTextW';
function GetKeyNameText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyNameText' + AWSuffix;
function GetKeyboardType; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetKeyboardType';
function ToAscii; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ToAscii';
function ToAsciiEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ToAsciiEx';
function ToUnicode; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ToUnicode';
function OemKeyScan; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OemKeyScan';
function VkKeyScanA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScanA';
function VkKeyScanW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScanW';
function VkKeyScan; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScan' + AWSuffix;
function VkKeyScanExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScanExA';
function VkKeyScanExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScanExW';
function VkKeyScanEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'VkKeyScanEx' + AWSuffix;
...
function MapVirtualKey; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapVirtualKey' + AWSuffix;
function MapVirtualKeyExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapVirtualKeyExA';
function MapVirtualKeyExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapVirtualKeyExW';
function MapVirtualKeyEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapVirtualKeyEx' + AWSuffix;
function GetInputState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetInputState';
function GetQueueStatus; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetQueueStatus';
function GetCapture; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCapture';
function SetCapture; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetCapture';
function ReleaseCapture; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ReleaseCapture';
function MsgWaitForMultipleObjects; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsgWaitForMultipleObjects';
function MsgWaitForMultipleObjectsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MsgWaitForMultipleObjectsEx';
function SetTimer; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetTimer';
function KillTimer; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'KillTimer';
function IsWindowUnicode; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsWindowUnicode';
function EnableWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnableWindow';
function IsWindowEnabled; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsWindowEnabled';
function LoadAcceleratorsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadAcceleratorsA';
function LoadAcceleratorsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadAcceleratorsW';
function LoadAccelerators; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadAccelerators' + AWSuffix;
function CreateAcceleratorTableA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateAcceleratorTableA';
function CreateAcceleratorTableW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateAcceleratorTableW';
function CreateAcceleratorTable; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateAcceleratorTable' + AWSuffix;
function DestroyAcceleratorTable; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyAcceleratorTable';
function CopyAcceleratorTableA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyAcceleratorTableA';
function CopyAcceleratorTableW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyAcceleratorTableW';
function CopyAcceleratorTable; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyAcceleratorTable' + AWSuffix;
function TranslateAcceleratorA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateAcceleratorA';
function TranslateAcceleratorW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateAcceleratorW';
function TranslateAccelerator; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateAccelerator' + AWSuffix;
function GetSystemMetrics; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSystemMetrics';
function LoadMenuA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenuAA';
function LoadMenuW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenuWA';
function LoadMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenu' + AWSuffix;
function LoadMenuIndirectA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenuIndirectA';
function LoadMenuIndirectW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenuIndirectW';
function LoadMenuIndirect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadMenuIndirect' + AWSuffix;
function GetMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenu';
function SetMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenu';
function ChangeMenuA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeMenuA';
function ChangeMenuW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeMenuW';
function ChangeMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeMenu' + AWSuffix;
function HiliteMenuItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'HiliteMenuItem';
function GetMenuStringA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuStringA';
function GetMenuStringW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuStringW';
function GetMenuString; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuString' + AWSuffix;
function GetMenuState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuState';
function DrawMenuBar; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawMenuBar';
function GetSystemMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSystemMenu';
function CreateMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMenu';
function CreatePopupMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreatePopupMenu';
function DestroyMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyMenu';
function CheckMenuItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CheckMenuItem';
function EnableMenuItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnableMenuItem';
function GetSubMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSubMenu';
function GetMenuItemID; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemID';
function GetMenuItemCount; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemCount';
function InsertMenuA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenuA';
function InsertMenuW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenuW';
function InsertMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenu' + AWSuffix;
function AppendMenuA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AppendMenuA';
function AppendMenuW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AppendMenuW';
function AppendMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AppendMenu' + AWSuffix;
function ModifyMenuA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ModifyMenuA';
function ModifyMenuW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ModifyMenuW';
function ModifyMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ModifyMenu' + AWSuffix;
function RemoveMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveMenu';
function DeleteMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeleteMenu';
function SetMenuItemBitmaps; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuItemBitmaps';
function GetMenuCheckMarkDimensions; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuCheckMarkDimensions';
function TrackPopupMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TrackPopupMenu';
function TrackPopupMenuEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TrackPopupMenuEx';
function GetMenuInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuInfo';
function SetMenuInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuInfo';
function EndMenu; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndMenu';
function InsertMenuItemA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenuItemA';
function InsertMenuItemW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenuItemW';
function InsertMenuItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InsertMenuItem' + AWSuffix;
function GetMenuItemInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemInfoA';
function GetMenuItemInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemInfoW';
function GetMenuItemInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemInfo' + AWSuffix;
function SetMenuItemInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuItemInfoA';
function SetMenuItemInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuItemInfoW';
function SetMenuItemInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuItemInfo' + AWSuffix;
function GetMenuDefaultItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuDefaultItem';
function SetMenuDefaultItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuDefaultItem';
function GetMenuItemRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuItemRect';
function MenuItemFromPoint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MenuItemFromPoint';
function DragObject; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DragObject';
function DragDetect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DragDetect';
function DrawIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawIcon';
function DrawTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawTextA';
function DrawTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawTextW';
function DrawText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawText' + AWSuffix;
function DrawTextExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawTextExA';
function DrawTextExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawTextExW';
function DrawTextEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawTextEx' + AWSuffix;
function GrayStringA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GrayStringA';
function GrayStringW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GrayStringW';
function GrayString; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GrayString' + AWSuffix;
function DrawStateA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawStateA';
function DrawStateW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawStateW';
function DrawState; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawState' + AWSuffix;
function TabbedTextOutA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TabbedTextOutA';
function TabbedTextOutW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TabbedTextOutW';
function TabbedTextOut; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TabbedTextOut' + AWSuffix;
function GetTabbedTextExtentA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTabbedTextExtentA';
function GetTabbedTextExtentW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTabbedTextExtentW';
function GetTabbedTextExtent; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTabbedTextExtent' + AWSuffix;
function UpdateWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UpdateWindow';
function SetActiveWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetActiveWindow';
function GetForegroundWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetForegroundWindow';
function PaintDesktop; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PaintDesktop';
procedure SwitchToThisWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SwitchToThisWindow';
function SetForegroundWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetForegroundWindow';
function AllowSetForegroundWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AllowSetForegroundWindow';
function LockSetForegroundWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LockSetForegroundWindow';
function WindowFromDC; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WindowFromDC';
function GetDC; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDC';
function GetDCEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDCEx';
function GetWindowDC; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowDC';
function ReleaseDC; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ReleaseDC';
function BeginPaint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'BeginPaint';
function EndPaint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndPaint';
function GetUpdateRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUpdateRect';
function GetUpdateRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetUpdateRgn';
function SetWindowRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowRgn';
function GetWindowRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowRgn';
function GetWindowRgnBox; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowRgnBox';
function ExcludeUpdateRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ExcludeUpdateRgn';
function InvalidateRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InvalidateRect';
function ValidateRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ValidateRect';
function InvalidateRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InvalidateRgn';
function ValidateRgn; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ValidateRgn';
function RedrawWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RedrawWindow';
function LockWindowUpdate; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LockWindowUpdate';
function ScrollWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScrollWindow';
function ScrollDC; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScrollDC';
function ScrollWindowEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScrollWindowEx';
function SetScrollPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetScrollPos';
function GetScrollPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetScrollPos';
function SetScrollRange; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetScrollRange';
function GetScrollRange; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetScrollRange';
function ShowScrollBar; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowScrollBar';
function EnableScrollBar; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnableScrollBar';
function SetPropA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPropA';
function SetPropW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetPropW';
function SetProp; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetProp' + AWSuffix;
function GetPropA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPropA';
function GetPropW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetPropW';
function GetProp; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetProp' + AWSuffix;
function RemovePropA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemovePropA';
function RemovePropW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemovePropW';
function RemoveProp; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RemoveProp' + AWSuffix;
function EnumPropsExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumPropsExA';
function EnumPropsExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumPropsExW';
function EnumPropsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumPropsEx' + AWSuffix;
function EnumPropsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumPropsA';
function EnumPropsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumPropsW';
function EnumProps; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumProps' + AWSuffix;
function SetWindowTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowTextA';
function SetWindowTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowTextW';
function SetWindowText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowText' + AWSuffix;
function GetWindowTextA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowTextA';
function GetWindowTextW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowTextW';
function GetWindowText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowText' + AWSuffix;
function GetWindowTextLengthA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowTextLengthA';
function GetWindowTextLengthW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowTextLengthW';
function GetWindowTextLength; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowTextLength' + AWSuffix;
function GetClientRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClientRect';
function GetWindowRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowRect';
function AdjustWindowRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AdjustWindowRect';
function AdjustWindowRectEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'AdjustWindowRectEx';
function SetWindowContextHelpId; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowContextHelpId';
function GetWindowContextHelpId; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowContextHelpId';
function SetMenuContextHelpId; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetMenuContextHelpId';
function GetMenuContextHelpId; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuContextHelpId';
function MessageBoxA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxA';
function MessageBoxW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxW';
function MessageBox; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBox' + AWSuffix;
function MessageBoxExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxExA';
function MessageBoxExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxExW';
function MessageBoxEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxEx' + AWSuffix;
function MessageBoxIndirectA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxIndirectA';
function MessageBoxIndirectW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxIndirectW';
function MessageBoxIndirect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBoxIndirect' + AWSuffix;
function MessageBeep; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MessageBeep';
function ShowCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowCursor';
function SetCursorPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetCursorPos';
function SetCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetCursor';
function GetCursorPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCursorPos';
function ClipCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ClipCursor';
function GetClipCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClipCursor';
function GetCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCursor';
function CreateCaret; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateCaret';
function GetCaretBlinkTime; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCaretBlinkTime';
function SetCaretBlinkTime; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetCaretBlinkTime';
function DestroyCaret; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyCaret';
function HideCaret; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'HideCaret';
function ShowCaret; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ShowCaret';
function SetCaretPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetCaretPos';
function GetCaretPos; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCaretPos';
function ClientToScreen; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ClientToScreen';
function ScreenToClient; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ScreenToClient';
function MapWindowPoints; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapWindowPoints';
function WindowFromPoint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WindowFromPoint';
function ChildWindowFromPoint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChildWindowFromPoint';
function ChildWindowFromPointEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChildWindowFromPointEx';
function GetSysColor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSysColor';
function GetSysColorBrush; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetSysColorBrush';
function SetSysColors; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetSysColors';
function DrawFocusRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawFocusRect';
function FillRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FillRect';
function FrameRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FrameRect';
function InvertRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InvertRect';
function SetRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetRect';
function SetRectEmpty; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetRectEmpty';
function CopyRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyRect';
function InflateRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InflateRect';
function IntersectRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IntersectRect';
function UnionRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnionRect';
function SubtractRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SubtractRect';
function OffsetRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'OffsetRect';
function IsRectEmpty; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsRectEmpty';
function EqualRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EqualRect';
function PtInRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PtInRect';
function GetWindowWord; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowWord';
function SetWindowWord; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowWord';
function GetWindowLongA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowLongA';
function GetWindowLongW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowLongW';
function GetWindowLong; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowLong' + AWSuffix;
function SetWindowLongA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowLongA';
function SetWindowLongW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowLongW';
function SetWindowLong; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowLong' + AWSuffix;
function GetClassWord; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassWord';
function SetClassWord; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClassWord';
function GetClassLongA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassLongA';
function GetClassLongW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassLongW';
function GetClassLong; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassLong' + AWSuffix;
function SetClassLongA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClassLongA';
function SetClassLongW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClassLongW';
function SetClassLong; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetClassLong' + AWSuffix;
function GetProcessDefaultLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetProcessDefaultLayout';
function SetProcessDefaultLayout; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetProcessDefaultLayout';
function GetDesktopWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetDesktopWindow';
function GetParent; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetParent';
function SetParent; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetParent';
function EnumChildWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumChildWindows';
function FindWindowA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindowA';
function FindWindowW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindowW';
function FindWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindow' + AWSuffix;
function FindWindowExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindowExA';
function FindWindowExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindowExW';
function FindWindowEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'FindWindowEx' + AWSuffix;
function GetShellWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetShellWindow';
function RegisterShellHookWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterShellHookWindow';
function DeregisterShellHookWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DeregisterShellHookWindow';
function EnumWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumWindows';
function EnumThreadWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumThreadWindows';
function GetClassNameA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassNameA';
function GetClassNameW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassNameW';
function GetClassName; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetClassName' + AWSuffix;
function GetTopWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTopWindow';
function GetWindowThreadProcessId; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowThreadProcessId';
function IsGUIThread; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsGUIThread';
function GetLastActivePopup; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetLastActivePopup';
function GetWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindow';
function SetWindowsHookA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHookA';
function SetWindowsHookW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHookW';
function SetWindowsHook; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHook' + AWSuffix;
function UnhookWindowsHook; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnhookWindowsHook';
function SetWindowsHookExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHookExA';
function SetWindowsHookExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHookExW';
function SetWindowsHookEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetWindowsHookEx' + AWSuffix;
function UnhookWindowsHookEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UnhookWindowsHookEx';
function CallNextHookEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CallNextHookEx';
function CheckMenuRadioItem; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CheckMenuRadioItem';
function LoadBitmapA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadBitmapA';
function LoadBitmapW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadBitmapW';
function LoadBitmap; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadBitmap' + AWSuffix;
function LoadCursorA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursorA';
function LoadCursorW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursorW';
function LoadCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursor' + AWSuffix;
function LoadCursorFromFileA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursorFromFileA';
function LoadCursorFromFileW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursorFromFileW';
function LoadCursorFromFile; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadCursorFromFile' + AWSuffix;
function CreateCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateCursor';
function DestroyCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyCursor';
function SetSystemCursor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetSystemCursor';
function LoadIconA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadIconA';
function LoadIconW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadIconW';
function LoadIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadIcon' + AWSuffix;
function PrivateExtractIconsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PrivateExtractIconsA';
function PrivateExtractIconsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PrivateExtractIconsW';
function PrivateExtractIcons; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'PrivateExtractIcons' + AWSuffix;
function CreateIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateIcon';
function DestroyIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DestroyIcon';
function LookupIconIdFromDirectory; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LookupIconIdFromDirectory';
function LookupIconIdFromDirectoryEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LookupIconIdFromDirectoryEx';
function CreateIconFromResource; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateIconFromResource';
function CreateIconFromResourceEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateIconFromResourceEx';
function LoadImageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadImageA';
function LoadImageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadImageW';
function LoadImage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadImage' + AWSuffix;
function CopyImage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyImage';
function DrawIconEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DrawIconEx';
function CreateIconIndirect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateIconIndirect';
function CopyIcon; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CopyIcon';
function GetIconInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetIconInfo';
function LoadStringA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadStringA';
function LoadStringW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadStringW';
function LoadString; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LoadString' + AWSuffix;
function IsDialogMessageA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsDialogMessageA';
function IsDialogMessageW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsDialogMessageW';
function IsDialogMessage; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsDialogMessage' + AWSuffix;
function MapDialogRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MapDialogRect';
function DlgDirListA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirListA';
function DlgDirListW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirListW';
function DlgDirList; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirList' + AWSuffix;
function DlgDirSelectExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectExA';
function DlgDirSelectExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectExW';
function DlgDirSelectEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectEx' + AWSuffix;
function DlgDirListComboBoxA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirListComboBoxA';
function DlgDirListComboBoxW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirListComboBoxW';
function DlgDirListComboBox; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirListComboBox' + AWSuffix;
function DlgDirSelectComboBoxExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectComboBoxExA';
function DlgDirSelectComboBoxExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectComboBoxExW';
function DlgDirSelectComboBoxEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DlgDirSelectComboBoxEx' + AWSuffix;
function SetScrollInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetScrollInfo';
function GetScrollInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetScrollInfo';
function DefFrameProcA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefFrameProcA';
function DefFrameProcW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefFrameProcW';
function DefFrameProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefFrameProc' + AWSuffix;
function DefMDIChildProcA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefMDIChildProcA';
function DefMDIChildProcW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefMDIChildProcW';
function DefMDIChildProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefMDIChildProc' + AWSuffix;
function TranslateMDISysAccel; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TranslateMDISysAccel';
function ArrangeIconicWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ArrangeIconicWindows';
function CreateMDIWindowA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMDIWindowA';
function CreateMDIWindowW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMDIWindowW';
function CreateMDIWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CreateMDIWindow' + AWSuffix;
function TileWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'TileWindows';
function CascadeWindows; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CascadeWindows';
function WinHelpA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WinHelpA';
function WinHelpW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WinHelpW';
function WinHelp; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'WinHelp' + AWSuffix;
function GetGuiResources; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetGuiResources';
function ChangeDisplaySettingsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettingsA';
function ChangeDisplaySettingsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettingsW';
function ChangeDisplaySettings; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettings' + AWSuffix;
function ChangeDisplaySettingsExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettingsExA';
function ChangeDisplaySettingsExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettingsExW';
function ChangeDisplaySettingsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'ChangeDisplaySettingsEx' + AWSuffix;
function EnumDisplaySettingsA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettingsA';
function EnumDisplaySettingsW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettingsW';
function EnumDisplaySettings; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettings' + AWSuffix;
function EnumDisplaySettingsExA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettingsExA';
function EnumDisplaySettingsExW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettingsExW';
function EnumDisplaySettingsEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplaySettingsEx' + AWSuffix;
function EnumDisplayDevicesA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplayDevicesA';
function EnumDisplayDevicesW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplayDevicesW';
function EnumDisplayDevices; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplayDevices' + AWSuffix;
function SystemParametersInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SystemParametersInfoA';
function SystemParametersInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SystemParametersInfoW';
function SystemParametersInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SystemParametersInfo' + AWSuffix;
procedure SetDebugErrorLevel; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetDebugErrorLevel';
procedure SetLastErrorEx; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetLastErrorEx';
function InternalGetWindowText; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InternalGetWindowText';
function EndTask; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EndTask';
function MonitorFromPoint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MonitorFromPoint';
function MonitorFromRect; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MonitorFromRect';
function MonitorFromWindow; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'MonitorFromWindow';
function GetMonitorInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMonitorInfoA';
function GetMonitorInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMonitorInfoW';
function GetMonitorInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMonitorInfo' + AWSuffix;
function EnumDisplayMonitors; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'EnumDisplayMonitors';
...
function IsWinEventHookInstalled; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'IsWinEventHookInstalled';
...
function GetCursorInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetCursorInfo';
function GetWindowInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetWindowInfo';
function GetTitleBarInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetTitleBarInfo';
function GetMenuBarInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetMenuBarInfo';
function GetScrollBarInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetScrollBarInfo';
function GetComboBoxInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetComboBoxInfo';
function GetAncestor; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAncestor';
function RealChildWindowFromPoint; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RealChildWindowFromPoint';
function RealGetWindowClassA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RealGetWindowClassA';
function RealGetWindowClassW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RealGetWindowClassW';
function RealGetWindowClass; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RealGetWindowClass' + AWSuffix;
function GetAltTabInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAltTabInfoA';
function GetAltTabInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAltTabInfoW';
function GetAltTabInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetAltTabInfo' + AWSuffix;
function GetListBoxInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetListBoxInfo';
function LockWorkStation; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'LockWorkStation';
function UserHandleGrantAccess; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'UserHandleGrantAccess';
function GetRawInputData; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputData';
function GetRawInputDeviceInfoA; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputDeviceInfoA';
function GetRawInputDeviceInfoW; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputDeviceInfoW';
function GetRawInputDeviceInfo; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputDeviceInfo' + AWSuffix;
function GetRawInputBuffer; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputBuffer';
function RegisterRawInputDevices; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'RegisterRawInputDevices';
function GetRegisteredRawInputDevices; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRegisteredRawInputDevices';
function GetRawInputDeviceList; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'GetRawInputDeviceList';
function DefRawInputProc; external user32 {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'DefRawInputProc';
